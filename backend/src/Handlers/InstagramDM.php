...
final class InstagramDM
{
    ...
    public static function getSettings(Request $req, Response $res, array $args): Response
    {
        ...
        $stats = $plan === 'demo' ? ['received'=>142,'sent'=>89,'unread'=>12,'followers'=>8400] : self::getStats($pdo,$tenant);
    ...
    {
        $names = ['@minjun_style','@shopaholic_j','@trendy_sejong','@biz_partner_k','@fashionista99'];
