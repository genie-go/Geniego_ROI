...
class CustomerAI
{
    ...
    private static function buildDemoCustomers(): array
    {
        ...
        $names = ['김지현','박민수','이수진','최동혁','정애련','강태영','임채원','유승호','배소연','서지훈',
                  'Yuki Tanaka','田中花子','Kenji Yamamoto','Chen Wei','Wang Fang'];
        $products = [
            ['id'=>'P001','name'=>'무선 이어폰 Pro X','cat'=>'전자제품','price'=>89000],
            ['id'=>'P002','name'=>'스마트 워치 SE','cat'=>'전자제품','price'=>189000],
            ['id'=>'P003','name'=>'USB-C 허브 7in1','cat'=>'전자제품','price'=>49000],
            ['id'=>'P004','name'=>'스킨케어 세트','cat'=>'뷰티','price'=>68000],
            ['id'=>'P005','name'=>'프리미엄 가방 (LV)','cat'=>'패션','price'=>450000],
            ['id'=>'P006','name'=>'러닝화 Air','cat'=>'스포츠','price'=>128000],
            ['id'=>'P007','name'=>'헤드폰 WH-1000XM5','cat'=>'전자제품','price'=>349000],
            ['id'=>'P008','name'=>'캠핑 LED 랜턴','cat'=>'아웃도어','price'=>38000],
        ];
    ...
    public static function churnScores(Request $req, Response $res): Response
    {
        ...
        $isDemoToken = ($plan === 'demo');

        if ($isDemoToken) {
            $customers = self::buildDemoCustomers();
            $summary = [
    ...
    public static function productRecommendations(Request $req, Response $res): Response
    {
        ...
        // 데모 상품 풀
        $products = [
            ['id'=>'P001','name'=>'무선 이어폰 Pro X','category'=>'전자제품','price'=>89000,'inventory'=>264,'sales_7d'=>142],
            ['id'=>'P002','name'=>'스마트 워치 SE','category'=>'전자제품','price'=>189000,'inventory'=>78,'sales_7d'=>67],
            ['id'=>'P003','name'=>'USB-C 허브 7in1','category'=>'전자제품','price'=>49000,'inventory'=>465,'sales_7d'=>234],
            ['id'=>'P004','name'=>'스킨케어 세트','category'=>'뷰티','price'=>68000,'inventory'=>189,'sales_7d'=>98],
            ['id'=>'P005','name'=>'프리미엄 가방','category'=>'패션','price'=>450000,'inventory'=>23,'sales_7d'=>18],
            ['id'=>'P006','name'=>'러닝화 Air','category'=>'스포츠','price'=>128000,'inventory'=>67,'sales_7d'=>45],
            ['id'=>'P007','name'=>'헤드폰 WH-1000XM5','category'=>'전자제품','price'=>349000,'inventory'=>34,'sales_7d'=>28],
            ['id'=>'P008','name'=>'캠핑 LED 랜턴','category'=>'아웃도어','price'=>38000,'inventory'=>134,'sales_7d'=>67],
        ];
    ...
    public static function ltvSegments(Request $req, Response $res): Response
    {
        ...
        if ($isDemo) {
            $segments = [
                ['tier'=>'diamond','label'=>'💎 다이아몬드','color'=>'#60a5fa','threshold'=>'₩1,000,000+',
                 'customer_count'=>847,'avg_ltv'=>2840000,'total_ltv'=>2403480000,'max_ltv'=>8900000,'action'=>'VIP 전용 혜택 제공'],
                ['tier'=>'gold','label'=>'🥇 골드','color'=>'#fbbf24','threshold'=>'₩500,000+',
                 'customer_count'=>2341,'avg_ltv'=>720000,'total_ltv'=>1685520000,'max_ltv'=>990000,'action'=>'프리미엄 멤버십 업그레이드'],
                ['tier'=>'silver','label'=>'🥈 실버','color'=>'#94a3b8','threshold'=>'₩200,000+',
                 'customer_count'=>4123,'avg_ltv'=>310000,'total_ltv'=>1278130000,'max_ltv'=>498000,'action'=>'골드 업그레이드 유도 캠페인'],
                ['tier'=>'bronze','label'=>'🥉 브론즈','color'=>'#cd7c4b','threshold'=>'₩50,000+',
                 'customer_count'=>3892,'avg_ltv'=>102000,'total_ltv'=>396984000,'max_ltv'=>198000,'action'=>'재구매 인센티브 이메일'],
                ['tier'=>'new','label'=>'🌱 신규','color'=>'#4ade80','threshold'=>'~₩50,000',
                 'customer_count'=>1644,'avg_ltv'=>18000,'total_ltv'=>29592000,'max_ltv'=>49000,'action'=>'온보딩 시리즈 여정 시작'],
            ];
