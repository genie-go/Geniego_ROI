...
final class ChannelSync
{
    ...
    {
        $names = ['무선 노이즈캔슬링 헤드폰', 'RGB 기계식 키보드', 'USB-C 7포트 허브', '4K 웹캠 Pro', '에르고 무선 마우스', 'GaN 60W 충전기'];
        $skus  = ['WH-1000XM5', 'KB-MXM-RGB', 'HC-USB4-7P', 'CAM-4K-PRO', 'MS-ERG-BL', 'CH-60W-GAN'];
    ...
    private static function demoOrders(string $channel): array
    {
        ...
        $products = ['무선 이어폰 Pro X','스마트워치 SE','USB-C 허브 7in1','캠핑 LED 랜턴','에르고 마우스','GaN 충전기'];
