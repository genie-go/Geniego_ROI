...
- /approvals → 결재 센터
- /attribution → 마케팅 어트리뷰션 — 실시간 ML 엔진 v3.0 · 광고성과 · 종합 대시보드 · 상품 마케팅 성과 · 어트리뷰션
- /audit → 감사 로그
- /auto-marketing → 마케팅 & 광고 성과 (Overview) · 자동화 전략 · AI Agent 권한모드
- /budget-tracker → 연동 허브 · 광고성과 · 종합 대시보드 · 상품 마케팅 성과
- /catalog-sync → 옴니 채널 · 종합 대시보드 · 상품 마케팅 성과
- /channel-kpi → 연동 허브 · 기본 채널 KPI 관리망 · 종합 대시보드 · 상품 마케팅 성과
- /content-calendar → 콘텐츠 캘린더
- /crm → 연동 허브 · 고객 관리 (CRM) · CRM 대시보드 · 광고성과 · 종합 대시보드 · 상품 마케팅 성과 · WhatsApp
- /dashboard → 마케팅 & 광고 성과 (Overview) · 종합 대시보드 · 광고성과 · 상품 마케팅 성과
...
- /email-marketing → 연동 허브 · 마케팅 & 광고 성과 (Overview) · 이메일 마케팅 · 광고성과 · 종합 대시보드 · 상품 마케팅 성과 · WhatsApp
- /graph-score → 그래프 스코어링 · 그래프 스코어
- /help → 플랫폼 가이드
- /influencer → 인플루언서 & UGC · 인플루언서
- /instagram-dm → 인스타 DM · WhatsApp
- /integration-hub → 연동 허브 · 회사정보 완성
- /journey-builder → 여정 빌더
- /kakao-channel → 마케팅 & 광고 성과 (Overview) · 카카오 비즈니스 · 광고성과 · WhatsApp
- /kr-channel → 🇰🇷 한국 채널 정산 허브 · 종합 대시보드 · 상품 마케팅 성과
- /license → license Activation · la
- /line-channel → LINE 채널 · WhatsApp
- /live-commerce → 라이브 커머스 · 종합 대시보드 · 상품 마케팅 성과
- /marketing → 마케팅 & 광고 성과 (Overview) · 광고성과 · 종합 대시보드 · 상품 마케팅 성과
- /marketing-mix → 연동 허브 · 마케팅 믹스 모델 (MMM) · 예산 최적화
- /menu-access-manager → 마케팅 & 광고 성과 (Overview) · menu Access
- /my-coupons → 연동 허브 · 내 쿠폰
- /omni-channel → 옴니 채널 · 종합 대시보드 · 상품 마케팅 성과 · WhatsApp
...
- /performance → 성과 허브 · 종합 대시보드 · 상품 마케팅 성과
- /pg-config → 게이트웨이 관리 · 결제 게이트웨이 관리
- /pixel-tracking → 픽셀 추적 · WhatsApp
- /pm → 포트폴리오 · 프로젝트 관리
- /pm/portfolio → 포트폴리오 / 프로그램 · 포트폴리오 · 획득가치관리 (EVM)
- /pm/resources → 포트폴리오 · 리소스 가용량 / 워크로드
- /pnl → 손익 분석 · P&L 손익 · 부가세 정산 · 종합 대시보드 · 상품 마케팅 성과
- /price-opt → 가격 최적화 엔진 · 종합 대시보드 · 상품 마케팅 성과
...
- /reconciliation → 정산 검증 · 종합 대시보드 · 상품 마케팅 성과
- /report-builder → 리포트 빌더 · 종합 대시보드 · 상품 마케팅 성과
- /reviews-ugc → 리뷰 및 UGC
- /rollup → 광고성과 · 고객 퍼널
- /rules-editor-v2 → 규칙 에디터 v2 (드래그&드롭 + 버전/승인/배포)
- /settlements → 채널 정산 관리 · 결제 내역 · 종합 대시보드 · 상품 마케팅 성과
- /sms-marketing → 마케팅 & 광고 성과 (Overview) · SMS 마케팅 · 광고성과 · 종합 대시보드 · 상품 마케팅 성과 · WhatsApp
