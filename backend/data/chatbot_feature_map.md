...
**★ 페이지 내부 기능 인덱스 (i18n 정본에서 자동 추출 — 라우트에 없지만 화면 안에 실제로 존재한다. 사용자가 아래 기능을 물으면 "없다"고 하지 말고, 해당 경로로 들어가서 쓰는 기능이라고 안내하라. 절차를 물으면 시스템이 별도로 주입하는 RELEVANT FEATURE DETAILS 블록을 근거로 단계별로 설명하라.)**
- /account-performance → 연동 허브 · 계정별 성과 분석
- /admin → 관리자 환경 · 인증 SMS(Twilio) 설정
- /admin/access-review → 연동 허브 · 🔐 접근 검토
- /admin/agencies → 대행사 계정 관리
- /admin/growth → 성장 센터
- /admin/legal-docs → 📜 법적 페이지 편집
- /admin/menu-tree → 메뉴 가시성 관리 (4계층)
- /admin/plan-pricing → 플랜별 구독요금 · 플랜별 제공 서비스 안내
- /admin/site-intro → 🏢 회사소개 · 연혁 · 운영진 관리
- /admin/sub-admins → 👤 하위 관리자 관리
- /agency-access → 대행사 접근 관리
- /ai-insights → AI 인사이트
- /ai-recommend → 🤖 AI 마케팅 추천 & 자동화 엔진 · media Editor spec · 🖼️ 이미지/동영상 업로드 편집기
- /ai-rule-engine → AI 룰 엔진
- /amazon-risk → amazon Risk
- /app-pricing → 플랜 및 업그레이드
- /approvals → 결재 센터
- /attribution → 마케팅 어트리뷰션 — 실시간 ML 엔진 v3.0 · 어트리뷰션 · 옴니 채널 · 상품 마케팅 성과
- /audit → 감사 로그
- /auto-marketing → 마케팅 & 광고 성과 (Overview) · AI Agent 권한모드 · 자동화 전략
- /budget-tracker → 연동 허브 · 어트리뷰션 · 옴니 채널 · 상품 마케팅 성과
- /campaign-manager → 캠페인 관리
- /case-study → 성공 사례
- /catalog-sync → 옴니 채널 · 연동 허브 · 브랜드 관리 · 상품정보제공고시 · 상품 마케팅 성과
- /channel-kpi → 연동 허브 · 기본 채널 KPI 관리망 · 옴니 채널 · 상품 마케팅 성과
- /content-calendar → 콘텐츠 캘린더
- /crm → 연동 허브 · 고객 관리 (CRM) · CRM 대시보드 · 어트리뷰션 · 옴니 채널 · 상품 마케팅 성과
- /dashboard → 마케팅 & 광고 성과 (Overview) · 종합 대시보드 · 옴니 채널 · 광고성과 · 상품 마케팅 성과
- /data-assets → 데이터 자산
- /data-product → 데이터 프로덕트
- /data-schema → 데이터 스키마
- /data-trust → 데이터 신뢰성
- /db-admin → DB 어드민
- /demand-forecast → AI 수요예측
- /developer-hub → 개발자 포털
- /digital-shelf → 디지털 쉘프 · digital Shelf harvest
- /email-marketing → 마케팅 & 광고 성과 (Overview) · 연동 허브 · 이메일 마케팅 · 어트리뷰션 · 옴니 채널 · 상품 마케팅 성과
- /feedback → 의견/피드백
- /graph-score → 그래프 스코어링 · 그래프 스코어
- /help → 플랫폼 가이드
- /influencer → 인플루언서 & UGC · 인플루언서
- /instagram-dm → 인스타 DM · 옴니 채널
- /integration-hub → 연동 허브 · 회사정보 완성
- /journey-builder → 여정 빌더
- /kakao-channel → 마케팅 & 광고 성과 (Overview) · 이메일 마케팅 · 카카오 비즈니스 · 어트리뷰션 · 옴니 채널
- /kr-channel → 🇰🇷 한국 채널 정산 허브 · 옴니 채널 · 상품 마케팅 성과
- /license → license Activation · la
- /line-channel → LINE 채널 · 옴니 채널
- /live-commerce → 라이브 커머스 · 옴니 채널 · 상품 마케팅 성과
- /live-guest → 라이브 방송 참여
- /marketing → 마케팅 & 광고 성과 (Overview) · 어트리뷰션 · 옴니 채널 · 광고성과 · 상품 마케팅 성과
- /marketing-mix → 연동 허브 · 마케팅 믹스 모델 (MMM) · 예산 최적화
- /menu-access-manager → 마케팅 & 광고 성과 (Overview) · menu Access
- /my-coupons → 연동 허브 · 내 쿠폰
- /omni-channel → 옴니 채널 · 상품 마케팅 성과
- /onboarding → 온보딩 맵
- /onsite-cro → 온사이트 CRO 실험 · 온사이트 CRO
- /operations → 마케팅 & 광고 성과 (Overview) · 운영 실행 목록
- /order-hub → 주문 허브
- /partner → 파트너 포털
- /payment-methods → 결제수단
- /payment/fail → payment
- /payment/success → payment Success
- /performance → 성과 허브 · 옴니 채널 · 상품 마케팅 성과
- /pg-config → 게이트웨이 관리 · 결제 게이트웨이 관리
- /pixel-tracking → 픽셀 추적 · 옴니 채널
- /pm → 포트폴리오 · 프로젝트 관리
- /pm/portfolio → 포트폴리오 / 프로그램 · 포트폴리오 · 획득가치관리 (EVM)
- /pm/resources → 포트폴리오 · 리소스 가용량 / 워크로드
- /pnl → 손익 분석 · P&L 손익 · 부가세 정산 · 옴니 채널 · 상품 마케팅 성과
- /price-opt → 가격 최적화 엔진 · 옴니 채널 · 상품 마케팅 성과
- /pricing → app Pricing · app Pricing cycle · 플랜별 제공 서비스 안내 · Complete your business profile · 비즈니스 성장에 맞춰 확장되는 요금제 · app Pricing comparison · app Pricing legal
- /reconciliation → 정산 검증 · 옴니 채널 · 상품 마케팅 성과
- /report-builder → 리포트 빌더 · 옴니 채널 · 상품 마케팅 성과
- /returns-portal → 반품 포털
- /reviews-ugc → 리뷰 및 UGC
- /rollup → 광고성과 · 고객 퍼널
- /rules-editor-v2 → rules Editor Page
- /settlements → 채널 정산 관리 · 옴니 채널 · 상품 마케팅 성과
- /sms-marketing → 마케팅 & 광고 성과 (Overview) · SMS 마케팅 · 이메일 마케팅 · 어트리뷰션 · 옴니 채널 · 상품 마케팅 성과
- /supply-chain → 공급망 관리
- /system-monitor → 연동 허브 · 🖥️ 시스템 모니터
- /team-members → 멤버 구성원
- /user-management → 멤버 구성원 · 회원 관리 · ⚙️ 통합 관리자 패널
- /web-popup → 웹 팝업
- /whatsapp → WhatsApp · 옴니 채널
- /wms-manager → WMS 재고관리 · CCTV 실시간 조회 · 로케이션(빈) 관리 · 바코드/시리얼 매핑 · 스캔 입출고·적치 · 웨이브 피킹
- /workspace → 웹 푸시 알림
- /writeback → 데이터 라이트백
