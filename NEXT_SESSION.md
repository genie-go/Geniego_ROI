...
## C. 배포 상태 (★ 미배포 누적)
- **미배포 frontend i18n 3건**: ①184차 live ns 407키(`4de2e58c1b`) ②185차 wms UI 463키(`648a3eba0c`) ③185차 가이드 143키(`9d1df2ec50`). 전부 push조차 미실시(로컬 커밋만). **다음 frontend 배포 시 일괄 반영 + push 필요**(사용자 승인 후).
- 운영 최신 라이브 dist는 여전히 184차 `index-BR37fCW5`(가이드 TOP8 포함, 위 3건 미반영).
...
- **미배포 3커밋 배포 + push**(사용자 승인 후, 수동 PuTTY).
