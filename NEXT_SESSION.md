...
### 우선순위 1 - Journey Builder 용어 단순화 (이월, 50차 51차 누적 보류)

- 50차 보류 사유: 한글 IME 작은따옴표 입력으로 33 to 58건 빌드 에러
- 51차 보류 사유: 4건 핵심 용어 미정의 + 검수자 권고 (우선순위 3 전환)
- 52차 진입 전 사용자가 4건 핵심 용어 직접 지정 필요
- 회차: 8 to 12
