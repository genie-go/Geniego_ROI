...
| §29 | Request 허용 전이 | **22** |
| §30 | Resource Snapshot 필드 | **21** |
| §30 | Snapshot Type | **8** |
| §31 | Critical Field 변경 목록 | **23** |
| §32 | Context Snapshot 필드 | **19** |
| §33 | Policy Reference 필드 | **14** |
| §33 | Policy Type | **13** |
| §34 | Correlation 대상 | **18** |
| §34 | Correlation 필드 | **11** |
| §35 | Idempotency 필드 | **14** |
| §35 | Idempotency Resolution | **6** |
| §36 | Withdrawal 필드 | **12** |
| §37 | Cancellation 필드 | **14** |
...
## §13-1. 🔴 289차 집계 오류 3건 — **원문이 정본** (에이전트 실측 정정)

**본 문서의 개수는 289차가 손으로 센 값**이고, [원문](SPEC_06A_4_5_3_1_5_3_1_VERBATIM.md)과 대조하니 **3건이 틀렸다**:

| 축 | 본 문서 초판 | **원문 실측** | 격차 |
|---|---|---|---|
| §39 Supersession 필드 | 13 | **14** | −1 |
| §40 Execution Binding 필드 | 19 | **20** | −1 |
| §42 Candidate 필드 | 22 | **26** | **−4**(최대) |
