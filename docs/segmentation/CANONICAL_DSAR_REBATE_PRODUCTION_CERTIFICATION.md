...
| **5** | 🟠 요구 목록 저장소 영속 | 중 | 커버리지 측정 가능화 · **현 사슬의 바닥** |
| **6** | 🟢 Rebate 구현 | 대 | **위 5건 후** |

~~**1·2가 §2 사슬의 바닥이다.**~~ **289차: 1·2·3·4 완료 → 이제 5(요구 목록 영속)가 바닥이다.**
...
>
> ⚠️ **5·6은 미완이고 06-A 판정은 `NOT_CERTIFIED` 불변이다** — 1·2·3·4 완료가 인증을 뜻하지 않는다.
