...
스펙 §26 의 **16종 원문 항목명은 저장소 미영속**(REQ 는 개수 `16` 만 고정 · 나열 부재) → **UNVERIFIED**.
**16종 창작 금지**(REQ §15 역산). 5-2 의 Authorization Obligation 명칭을 **전용하지 않는다** —
인가 의무(마스킹·내보내기 제한 등)와 승인 의무(승인 후 이행 조건)는 **다른 축**이다(§4.7).
...
- **Obligation 열거형 창작 후 정본화 금지** — 스펙 §26 원문 수령 후 채운다.
