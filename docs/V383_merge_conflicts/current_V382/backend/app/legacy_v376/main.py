...
from app.api.v372 import router as v372_router
from app.api.v373 import router as v373_router
from app.api.v374 import router as v374_router
from app.api.v375 import router as v375_router
from app.api.v376 import router as v376_router
from app.core.config import settings

Base.metadata.create_all(bind=engine)

app = FastAPI(title="GENIE_ROI API", version="375.0.0")
app.include_router(v367_router)
app.include_router(v372_router)
app.include_router(v373_router)
app.include_router(v374_router)
app.include_router(v375_router)
app.include_router(v376_router)
security = HTTPBearer()
...
@app.get("/health")
def health():
    return {"ok": True, "version": "376.0.0"}
