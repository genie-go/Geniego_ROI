...
from scripts.v320._common import load_json, read_csv_dicts, safe_int, safe_float, infer_currency_from_filename
...
def main():
    ...
    p.add_argument("--settings", default="templates/v320/default_settings.json")
    args = p.parse_args()
