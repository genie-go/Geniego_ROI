...
## V253 Added
- SaaS UI: /ui
- Real-time events (SSE): /v253/stream/events
- Auto pipeline + report: POST /v253/workflows/run
- Reports: /v253/reports/latest, /v253/reports/{id}
- Pricing strategy simulator: POST /v253/pricing/simulate
