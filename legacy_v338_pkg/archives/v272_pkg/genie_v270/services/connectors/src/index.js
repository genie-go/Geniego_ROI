...
app.post("/v261/connectors/execute", async (req,res) => executeHandler(req,res));
app.post("/v261/connectors/rollback", async (req,res) => rollbackHandler(req,res));
app.post("/v262/connectors/execute", async (req,res) => executeHandler(req,res));
app.post("/v262/connectors/rollback", async (req,res) => rollbackHandler(req,res));
app.post("/v263/connectors/execute", async (req,res) => executeHandler(req,res));
app.post("/v263/connectors/rollback", async (req,res) => rollbackHandler(req,res));
app.post("/v264/connectors/execute", async (req,res) => executeHandler(req,res));
app.post("/v264/connectors/rollback", async (req,res) => rollbackHandler(req,res));
app.post("/v265/connectors/execute", async (req,res) => executeHandler(req,res));
app.post("/v265/connectors/rollback", async (req,res) => rollbackHandler(req,res));
app.post("/v266/connectors/execute", async (req,res) => executeHandler(req,res));
app.post("/v266/connectors/rollback", async (req,res) => rollbackHandler(req,res));
app.post("/v267/connectors/execute", async (req,res) => executeHandler(req,res));
app.post("/v267/connectors/rollback", async (req,res) => rollbackHandler(req,res));
app.post("/v268/connectors/execute", async (req,res) => executeHandler(req,res));
app.post("/v268/connectors/rollback", async (req,res) => rollbackHandler(req,res));
app.post("/v269/connectors/execute", async (req,res) => executeHandler(req,res));
app.post("/v269/connectors/rollback", async (req,res) => rollbackHandler(req,res));

nst { execution_id, channel, dry_run, targets } = req.body || {};
  if (!execution_id || !channel) return res.status(400).json({error:"missing_fields"});
  const useDry = (dry_run !== undefined) ? !!dry_run : DRY_RUN;
