...
from scripts.v319._common import load_json, read_csv_dicts, safe_int, safe_float, infer_currency_from_filename
...
def main():
    ...
    p.add_argument("--settings", default="templates/v319/default_settings.json")
    args = p.parse_args()
