#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""GENIE_ROI V325 Permissions (fine-grained)

V323: role-based (viewer/analyst/manager/admin)
V325: keeps roles but adds fine-grained permission checks for operations,
      plus "approver" capability for approval workflow.

Design:
- Roles map to permission sets (static defaults).
- Per-project overrides may be applied via templates/v325/permissions_override.json.
