#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""GENIE_ROI V325 Data Connectors (auto collection)
...
- Supports credentials via project-local config file:
  projects/<project_id>/templates/v325/connectors.json
...
def load_connectors_config(project_root: pathlib.Path) -> Dict[str,Any]:
    p = project_root/"templates"/"v325"/"connectors.json"
    if not p.exists():
