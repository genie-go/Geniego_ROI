...
# -*- coding: utf-8 -*-
"""
GENIE_ROI V332 Web UI (SaaS-feeling + Compliance + Monitoring)
...
from scripts.v332.security import (
    hash_password, verify_password,
    sign_session, verify_session, Session
)
from scripts.v332.ops_store import OpsStore
from scripts.v332.pixel import make_pixel_js
from scripts.v332.connectors_smartstore import SmartStoreOAuth
from scripts.v332 import notifier
from scripts.v332.queue_worker import QueueWorker
...
def main():
    ...
    print(f"[V332] workspace={workspace}  http://{args.host}:{args.port}/dashboard/login_v331.html")
    print("[V332] default users (if first run): admin/admin , analyst/analyst , viewer/viewer")
