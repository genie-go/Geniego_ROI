#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""GENIE_ROI V324 Ops Store (audit log, approvals, job queue)

All stored in a single SQLite db under workspace/data/ops_v324.db
Stdlib-only.
...
class OpsStore:
    def __init__(self, workspace: pathlib.Path):
        ...
        self.db_path = (workspace/"data"/"ops_v324.db")
