...
from scripts.v333.security import (
    hash_password, verify_password,
    sign_session, verify_session, Session
)
from scripts.v333.ops_store import OpsStore
from scripts.v333.pixel import make_pixel_js
from scripts.v333.connectors_smartstore import SmartStoreOAuth
from scripts.v333 import notifier
from scripts.v333.queue_worker import QueueWorker
...
class Handler(BaseHTTPRequestHandler):
    ...
    def _do_GET(self):
        ...
        # V333: id graph split request (analyst+)
        ...
        # V333: list split requests (manager+)
        ...
        # V333: approve/reject split request (manager+)
                    ...
                    for p in proj_root.iterdir():
                        ...
                        if breaches:
                            ...
                            if last_age is None or last_age > cooldown:
                                # V333: attach dashboard/runbook links + recent error summary + optional auto recovery
                                ...
                                runbook_url = os.getenv("GENIE_ROI_RUNBOOK_URL","").strip() or f"{dash_base}/docs/v333/V333_RUNBOOK_KO.html"
