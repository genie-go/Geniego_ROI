...
from scripts.v321._common import load_json, read_csv_dicts, safe_int, safe_float, infer_currency_from_filename
...
def main():
    ...
    p.add_argument("--fx", default="templates/v321/fx_rates.json")
    p.add_argument("--settings", default="templates/v321/default_settings.json")
    args = p.parse_args()
    ...
    if not fmap:
        raise SystemExit("No custom mapper for this channel. UI에서 매핑을 저장한 뒤 업로드하세요.")
