...
GENIE_ROI V321 dashboard JSON generator
...
def load_attribution(cur, default_path="templates/v321/default_attribution.json"):
...
def main():
    ...
    p.add_argument("--default-attribution", default="templates/v321/default_attribution.json")
    ...
    db.close()
    print(f"[OK] V321 wrote JSON to {out.resolve()} (chain={' > '.join(chain)}, min_score={min_score})")
