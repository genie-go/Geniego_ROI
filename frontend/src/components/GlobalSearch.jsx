...
const ALL_MENUS = [
    ...
    { to: "/pricing", icon: "💳", label: "Plan·결제", section: "정산·재무", keywords: "Plan 결제 구독 Upgrade PRO DEMO" },
    // ⑥ 자동화·AI
    ...
    // ⑧ 시스템·관리
    { to: "/user-management", icon: "👥", label: "회원·권한 관리", section: "시스템·관리", keywords: "회원 권한 Admin 편집자 뷰어 역할 User" },
    { to: "/admin", icon: "⚙", label: "Admin Settings", section: "시스템·관리", keywords: "Admin Settings 시스템 Settings 환경 구성" },
    { to: "/system-monitor", icon: "🖥️", label: "시스템 모니터", section: "시스템·관리", keywords: "시스템 모니터 서버 상태 API 응답 성능" },
