...
export default function HelpPanel({ open, onClose }) {
    ...
    const STATIC_HELP = useMemo(() => ({
        "/connectors": { title: t('helpPanel.staticHelp.connectors.title'), icon: "🔌", summary: t('helpPanel.staticHelp.connectors.summary'), steps: Array.isArray(t('helpPanel.staticHelp.connectors.steps')) ? t('helpPanel.staticHelp.connectors.steps') : [], tips: Array.isArray(t('helpPanel.staticHelp.connectors.tips')) ? t('helpPanel.staticHelp.connectors.tips') : [] },
        "/api-keys": { title: t('helpPanel.staticHelp.apiKeys.title'), icon: "🔑", summary: t('helpPanel.staticHelp.apiKeys.summary'), steps: Array.isArray(t('helpPanel.staticHelp.apiKeys.steps')) ? t('helpPanel.staticHelp.apiKeys.steps') : [], tips: Array.isArray(t('helpPanel.staticHelp.apiKeys.tips')) ? t('helpPanel.staticHelp.apiKeys.tips') : [] },
        "/user-management": { title: t('helpPanel.staticHelp.userMgmt.title'), icon: "👥", summary: t('helpPanel.staticHelp.userMgmt.summary'), steps: Array.isArray(t('helpPanel.staticHelp.userMgmt.steps')) ? t('helpPanel.staticHelp.userMgmt.steps') : [], tips: Array.isArray(t('helpPanel.staticHelp.userMgmt.tips')) ? t('helpPanel.staticHelp.userMgmt.tips') : [] },
        "/help": { title: t('helpPanel.staticHelp.help.title'), icon: "📚", summary: t('helpPanel.staticHelp.help.summary'), steps: Array.isArray(t('helpPanel.staticHelp.help.steps')) ? t('helpPanel.staticHelp.help.steps') : [], tips: [] },
        "/sms-marketing": { title: t('helpPanel.staticHelp.smsMarketing.title'), icon: "💬", summary: t('helpPanel.staticHelp.smsMarketing.summary'), steps: Array.isArray(t('helpPanel.staticHelp.smsMarketing.steps')) ? t('helpPanel.staticHelp.smsMarketing.steps') : [], tips: Array.isArray(t('helpPanel.staticHelp.smsMarketing.tips')) ? t('helpPanel.staticHelp.smsMarketing.tips') : [] },
    }), [t]);
    ...
    const highlight = (text, q) => {
        ...
        return (
            <>
                {text.slice(0, idx)}
                <mark style={{ background: "rgba(79,142,247,0.4)", color: 'var(--text-1)', borderRadius: 3, padding: "0 2px" }}>
