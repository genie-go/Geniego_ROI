...
const LOC = {
  ...
  es: {
    totalOrders:'Pedidos Totales', grossRevenue:'Ingresos Brutos', returnRate:'Tasa de Devolución',
    reconRate:'Tasa de Conciliación', liveSync:'Sincronización en Vivo', settled:'Liquidado',
    targetB3:'Objetivo < 3%', autoMatch:'Coincidencia Automática', today:'Hoy', total:'Total',
    orderPipeline:'Pipeline de Pedidos', platformIntel:'Inteligencia de Plataforma',
    ordersCount:'Pedidos', totalSales:'Ventas Totales', avgOrder:'Pedido Prom.',
    retRate:'Tasa de Devolución', mobileRatio:'Móvil', peakTime:'Hora Pico',
    buyerGender:'Género del Comprador', maleBuyer:'👨 Masculino', femaleBuyer:'👩 Femenino',
    buyerAge:'Edad del Comprador', regionOrders:'Pedidos por Región',
    catPay:'Categoría y Pago', peakHourStr:'Hora Pico:',
    liveTotalOrd:'En Vivo · Pedidos Totales', syncTotalRev:'Ingresos Totales',
    syncSettled:'Liquidado', syncOpProfit:'Beneficio Operativo', unitCount:'',
    recentOrdersClick:'Pedidos Recientes (Clic → Detalles)',
    platRevShare:'Participación de Ingresos por Plataforma', noOrdersText:'No se encontraron pedidos.',
    platClickHint1:'Haga clic en una plataforma', platClickHint2:'para ver género, edad, región, categoría, método de pago', platClickHint3:'del comprador',
    flowVisit:'Visitas', flowCart:'Carrito', flowCheckout:'Pago', flowPurchase:'Compra',
    revenue:'Ingresos',
  },
  fr: {
    totalOrders:'Commandes Totales', grossRevenue:'Revenu Brut', returnRate:'Taux de Retour',
    reconRate:'Taux de Réconciliation', liveSync:'Sync en Direct', settled:'Réglé',
    targetB3:'Cible < 3%', autoMatch:'Correspondance Auto', today:"Aujourd'hui", total:'Total',
    orderPipeline:'Pipeline de Commandes', platformIntel:'Intelligence Plateforme',
    ordersCount:'Commandes', totalSales:'Ventes Totales', avgOrder:'Panier Moyen',
    retRate:'Taux de Retour', mobileRatio:'Mobile', peakTime:'Heure de Pointe',
    buyerGender:"Genre de l'Acheteur", maleBuyer:'👨 Homme', femaleBuyer:'👩 Femme',
    buyerAge:"Âge de l'Acheteur", regionOrders:'Commandes par Région',
    catPay:'Catégorie et Paiement', peakHourStr:'Heure de Pointe:',
    liveTotalOrd:'En Direct · Commandes Totales', syncTotalRev:'Revenu Total',
    syncSettled:'Réglé', syncOpProfit:'Bénéfice Opérationnel', unitCount:'',
    recentOrdersClick:'Commandes Récentes (Clic → Détails)',
    platRevShare:'Part de Revenu par Plateforme', noOrdersText:'Aucune commande trouvée.',
    platClickHint1:'Cliquez sur une plateforme', platClickHint2:'pour voir genre, âge, région, catégorie, paiement', platClickHint3:"de l'acheteur",
    flowVisit:'Visites', flowCart:'Panier', flowCheckout:'Paiement', flowPurchase:'Achat',
    revenue:'Revenu',
  },
  pt: {
    totalOrders:'Pedidos Totais', grossRevenue:'Receita Bruta', returnRate:'Taxa de Devolução',
    reconRate:'Taxa de Conciliação', liveSync:'Sincronização ao Vivo', settled:'Liquidado',
    targetB3:'Meta < 3%', autoMatch:'Correspondência Automática', today:'Hoje', total:'Total',
    orderPipeline:'Pipeline de Pedidos', platformIntel:'Inteligência de Plataforma',
    ordersCount:'Pedidos', totalSales:'Vendas Totais', avgOrder:'Ticket Médio',
    retRate:'Taxa de Devolução', mobileRatio:'Mobile', peakTime:'Hora de Pico',
    buyerGender:'Gênero do Comprador', maleBuyer:'👨 Masculino', femaleBuyer:'👩 Feminino',
    buyerAge:'Idade do Comprador', regionOrders:'Pedidos por Região',
    catPay:'Categoria e Pagamento', peakHourStr:'Hora de Pico:',
    liveTotalOrd:'Ao Vivo · Pedidos Totais', syncTotalRev:'Receita Total',
    syncSettled:'Liquidado', syncOpProfit:'Lucro Operacional', unitCount:'',
    recentOrdersClick:'Pedidos Recentes (Clique → Detalhes)',
    platRevShare:'Participação de Receita por Plataforma', noOrdersText:'Nenhum pedido encontrado.',
    platClickHint1:'Clique em uma plataforma', platClickHint2:'para ver gênero, idade, região, categoria, pagamento', platClickHint3:'do comprador',
    flowVisit:'Visitas', flowCart:'Carrinho', flowCheckout:'Checkout', flowPurchase:'Compra',
    revenue:'Receita',
  },
  ru: {
    totalOrders:'Всего заказов', grossRevenue:'Валовой доход', returnRate:'Процент возвратов',
    reconRate:'Процент сверки', liveSync:'Синхронизация', settled:'Рассчитано',
    targetB3:'Цель < 3%', autoMatch:'Автосверка', today:'Сегодня', total:'Итого',
    orderPipeline:'Pipeline заказов', platformIntel:'Аналитика платформы',
    ordersCount:'Заказы', totalSales:'Общие продажи', avgOrder:'Ср. чек',
    retRate:'Процент возвратов', mobileRatio:'Мобильные', peakTime:'Пиковое время',
    buyerGender:'Пол покупателя', maleBuyer:'👨 Мужской', femaleBuyer:'👩 Женский',
    buyerAge:'Возраст покупателя', regionOrders:'Заказы по регионам',
    catPay:'Категория и оплата', peakHourStr:'Пиковое время:',
    liveTotalOrd:'Онлайн · Всего заказов', syncTotalRev:'Общий доход',
    syncSettled:'Рассчитано', syncOpProfit:'Операционная прибыль', unitCount:'',
    recentOrdersClick:'Последние заказы (Клик → Детали)',
    platRevShare:'Доля дохода по платформам', noOrdersText:'Заказы не найдены.',
    platClickHint1:'Нажмите на платформу', platClickHint2:'для просмотра пола, возраста, региона, категории, оплаты', platClickHint3:'покупателя',
    flowVisit:'Визиты', flowCart:'Корзина', flowCheckout:'Оформление', flowPurchase:'Покупка',
    revenue:'Доход',
  },
  ar: {
    totalOrders:'إجمالي الطلبات', grossRevenue:'الإيراد الإجمالي', returnRate:'معدل الإرجاع',
    reconRate:'معدل التسوية', liveSync:'مزامنة مباشرة', settled:'تمت التسوية',
    targetB3:'الهدف < 3%', autoMatch:'مطابقة تلقائية', today:'اليوم', total:'الإجمالي',
    orderPipeline:'مسار الطلبات', platformIntel:'تحليلات المنصة',
    ordersCount:'الطلبات', totalSales:'إجمالي المبيعات', avgOrder:'متوسط الطلب',
    retRate:'معدل الإرجاع', mobileRatio:'الجوال', peakTime:'وقت الذروة',
    buyerGender:'جنس المشتري', maleBuyer:'👨 ذكر', femaleBuyer:'👩 أنثى',
    buyerAge:'فئة عمر المشتري', regionOrders:'طلبات حسب المنطقة',
    catPay:'الفئة والدفع', peakHourStr:'وقت الذروة:',
    liveTotalOrd:'مباشر · إجمالي الطلبات', syncTotalRev:'إجمالي الإيرادات',
    syncSettled:'تمت التسوية', syncOpProfit:'الربح التشغيلي', unitCount:'',
    recentOrdersClick:'الطلبات الأخيرة (انقر → التفاصيل)',
    platRevShare:'حصة الإيرادات حسب المنصة', noOrdersText:'لم يتم العثور على طلبات.',
    platClickHint1:'انقر على بطاقة المنصة', platClickHint2:'لعرض الجنس والعمر والمنطقة والفئة وطريقة الدفع', platClickHint3:'للمشتري',
    flowVisit:'الزيارات', flowCart:'السلة', flowCheckout:'الدفع', flowPurchase:'الشراء',
    revenue:'الإيرادات',
  },
  hi: {
    totalOrders:'कुल ऑर्डर', grossRevenue:'सकल राजस्व', returnRate:'वापसी दर',
    reconRate:'सुलह दर', liveSync:'लाइव सिंक', settled:'निपटान',
    targetB3:'लक्ष्य < 3%', autoMatch:'ऑटो मैच', today:'आज', total:'कुल',
    orderPipeline:'ऑर्डर पाइपलाइन', platformIntel:'प्लेटफ़ॉर्म इंटेलिजेंस',
    ordersCount:'ऑर्डर', totalSales:'कुल बिक्री', avgOrder:'औसत ऑर्डर',
    retRate:'वापसी दर', mobileRatio:'मोबाइल', peakTime:'पीक समय',
    buyerGender:'खरीदार का लिंग', maleBuyer:'👨 पुरुष', femaleBuyer:'👩 महिला',
    buyerAge:'खरीदार की उम्र', regionOrders:'क्षेत्र के अनुसार ऑर्डर',
    catPay:'श्रेणी और भुगतान', peakHourStr:'पीक समय:',
    liveTotalOrd:'लाइव · कुल ऑर्डर', syncTotalRev:'कुल राजस्व',
    syncSettled:'निपटान', syncOpProfit:'परिचालन लाभ', unitCount:'',
    recentOrdersClick:'हाल के ऑर्डर (क्लिक → विवरण)',
    platRevShare:'प्लेटफ़ॉर्म के अनुसार राजस्व हिस्सा', noOrdersText:'कोई ऑर्डर नहीं मिला।',
    platClickHint1:'प्लेटफ़ॉर्म कार्ड पर क्लिक करें', platClickHint2:'लिंग, उम्र, क्षेत्र, श्रेणी, भुगतान देखने के लिए', platClickHint3:'खरीदार का',
    flowVisit:'विज़िट', flowCart:'कार्ट', flowCheckout:'चेकआउट', flowPurchase:'खरीदारी',
    revenue:'राजस्व',
  },
};
