...
const LOC = {
  ...
  es: {
    liveGlobal:'En Vivo · Global', countryStatus:'Ventas', countries:' Países',
    totalGlobalRev:'Ingreso Global Total', totalOrders:'Pedidos Totales', opProfit:'Beneficio Op.',
    globalRevenue:'Ingreso Global', avgGrowth:'Crec. Promedio', topMarket:'Mercado Principal',
    activeCountries:'Países Activos', channelPerf:'🏗 Canales', growthRate:'📈 Crecimiento',
    popularProducts:'🏷 Productos', channelRevRoas:'Ingreso y ROAS por Canal',
    shareRate:'Participación', highGrowthTop5:'🚀 Top 5 Mercados Alto Crecimiento',
    cautionMarket:'⚠️ Mercados de Precaución (Bajo/Negativo)',
    globalTopProducts:'Top 5 Productos Globales Populares',
    mapClickHint:'💡 Haga clic en el mapa o seleccione un país de la lista',
    countryRevRank:'🏆 Ranking de Contribución de Ingresos por País',
    selectCountryHint:'Seleccione un país para ver análisis detallado',
    selectFromMap:'Haga clic en un marcador o seleccione de la lista',
    revContrib:'Contribución de Ingresos', growth:'Crecimiento', totalRev:'Ingreso Total',
    orders:'Pedidos', contrib:'Contribución', growthRate2:'Tasa de Crecimiento',
    topChannels:'🏆 Canales Principales (Top 3)', popularProductsLabel:'📦 Productos Populares',
    channelRevByCountry:'Ingreso por Canal', regionRev:'📍 Ingreso Regional',
    genderRatio:'👥 Ratio de Compra por Género', male:'Masculino', female:'Femenino', other:'Otro',
    ageGroupRatio:'📊 Ratio de Compra por Edad',
    countryOverview:'Resumen', countryChannel:'Canales', countryRegion:'Región', countryDemo:'Demografía',
    unit:'',
  },
  fr: {
    liveGlobal:'En Direct · Mondial', countryStatus:'Ventes', countries:' Pays',
    totalGlobalRev:'Revenu Mondial Total', totalOrders:'Commandes Totales', opProfit:'Bénéfice Op.',
    globalRevenue:'Revenu Mondial', avgGrowth:'Croissance Moy.', topMarket:'Marché Principal',
    activeCountries:'Pays Actifs', channelPerf:'🏗 Canaux', growthRate:'📈 Croissance',
    popularProducts:'🏷 Produits', channelRevRoas:'Revenu et ROAS par Canal',
    shareRate:'Part', highGrowthTop5:'🚀 Top 5 Marchés Forte Croissance',
    cautionMarket:'⚠️ Marchés à Surveiller (Faible/Négatif)',
    globalTopProducts:'Top 5 Produits Mondiaux Populaires',
    mapClickHint:'💡 Cliquez sur la carte ou sélectionnez un pays',
    countryRevRank:'🏆 Classement Contribution Revenu par Pays',
    selectCountryHint:'Sélectionnez un pays pour une analyse détaillée',
    selectFromMap:'Cliquez sur un marqueur ou sélectionnez dans la liste',
    revContrib:'Contribution au Revenu', growth:'Croissance', totalRev:'Revenu Total',
    orders:'Commandes', contrib:'Contribution', growthRate2:'Taux de Croissance',
    topChannels:'🏆 Canaux Principaux (Top 3)', popularProductsLabel:'📦 Produits Populaires',
    channelRevByCountry:'Revenu par Canal', regionRev:'📍 Revenu Régional',
    genderRatio:'👥 Ratio Achat par Genre', male:'Homme', female:'Femme', other:'Autre',
    ageGroupRatio:'📊 Ratio Achat par Âge',
    countryOverview:'Aperçu', countryChannel:'Canaux', countryRegion:'Région', countryDemo:'Démographie',
    unit:'',
  },
  pt: {
    liveGlobal:'Ao Vivo · Global', countryStatus:'Vendas', countries:' Países',
    totalGlobalRev:'Receita Global Total', totalOrders:'Pedidos Totais', opProfit:'Lucro Op.',
    globalRevenue:'Receita Global', avgGrowth:'Cresc. Médio', topMarket:'Mercado Principal',
    activeCountries:'Países Ativos', channelPerf:'🏗 Canais', growthRate:'📈 Crescimento',
    popularProducts:'🏷 Produtos', channelRevRoas:'Receita e ROAS por Canal',
    shareRate:'Participação', highGrowthTop5:'🚀 Top 5 Mercados Alto Crescimento',
    cautionMarket:'⚠️ Mercados de Atenção (Baixo/Negativo)',
    globalTopProducts:'Top 5 Produtos Globais Populares',
    mapClickHint:'💡 Clique no mapa ou selecione um país da lista',
    countryRevRank:'🏆 Ranking de Contribuição de Receita por País',
    selectCountryHint:'Selecione um país para ver análise detalhada',
    selectFromMap:'Clique em um marcador ou selecione da lista',
    revContrib:'Contribuição de Receita', growth:'Crescimento', totalRev:'Receita Total',
    orders:'Pedidos', contrib:'Contribuição', growthRate2:'Taxa de Crescimento',
    topChannels:'🏆 Canais Principais (Top 3)', popularProductsLabel:'📦 Produtos Populares',
    channelRevByCountry:'Receita por Canal', regionRev:'📍 Receita Regional',
    genderRatio:'👥 Ratio de Compra por Gênero', male:'Masculino', female:'Feminino', other:'Outro',
    ageGroupRatio:'📊 Ratio de Compra por Idade',
    countryOverview:'Visão Geral', countryChannel:'Canais', countryRegion:'Região', countryDemo:'Demografia',
    unit:'',
  },
  ru: {
    liveGlobal:'Онлайн · Глобально', countryStatus:'Продажи', countries:' Стран',
    totalGlobalRev:'Глобальный доход', totalOrders:'Всего заказов', opProfit:'Опер. прибыль',
    globalRevenue:'Глобальный доход', avgGrowth:'Ср. рост', topMarket:'Топ рынок',
    activeCountries:'Активные страны', channelPerf:'🏗 Каналы', growthRate:'📈 Рост',
    popularProducts:'🏷 Продукты', channelRevRoas:'Доход и ROAS по каналам',
    shareRate:'Доля', highGrowthTop5:'🚀 Топ 5 быстрорастущих рынков',
    cautionMarket:'⚠️ Рынки внимания (Низкий/Отрицательный рост)',
    globalTopProducts:'Топ 5 глобальных популярных продуктов',
    mapClickHint:'💡 Нажмите на карту или выберите страну из списка',
    countryRevRank:'🏆 Рейтинг вклада в доход по странам',
    selectCountryHint:'Выберите страну для детального анализа',
    selectFromMap:'Нажмите маркер на карте или выберите из списка',
    revContrib:'Вклад в доход', growth:'Рост', totalRev:'Общий доход',
    orders:'Заказы', contrib:'Вклад', growthRate2:'Темп роста',
    topChannels:'🏆 Основные каналы (Топ 3)', popularProductsLabel:'📦 Популярные продукты',
    channelRevByCountry:'Доход по каналам', regionRev:'📍 Региональный доход',
    genderRatio:'👥 Соотношение покупок по полу', male:'Мужской', female:'Женский', other:'Другой',
    ageGroupRatio:'📊 Соотношение покупок по возрасту',
    countryOverview:'Обзор', countryChannel:'Каналы', countryRegion:'Регион', countryDemo:'Демография',
    unit:'',
  },
  ar: {
    liveGlobal:'مباشر · عالمي', countryStatus:'المبيعات', countries:' دولة',
    totalGlobalRev:'إجمالي الإيرادات العالمية', totalOrders:'إجمالي الطلبات', opProfit:'الربح التشغيلي',
    globalRevenue:'الإيرادات العالمية', avgGrowth:'متوسط النمو', topMarket:'أكبر سوق',
    activeCountries:'الدول النشطة', channelPerf:'🏗 القنوات', growthRate:'📈 النمو',
    popularProducts:'🏷 المنتجات', channelRevRoas:'إيرادات وROAS القنوات',
    shareRate:'الحصة', highGrowthTop5:'🚀 أعلى 5 أسواق نمواً',
    cautionMarket:'⚠️ أسواق تحتاج انتباه (نمو منخفض/سلبي)',
    globalTopProducts:'أشهر 5 منتجات عالمية',
    mapClickHint:'💡 انقر على الخريطة أو اختر دولة من القائمة',
    countryRevRank:'🏆 ترتيب مساهمة الإيرادات حسب الدولة',
    selectCountryHint:'اختر دولة لعرض التحليل التفصيلي',
    selectFromMap:'انقر على علامة في الخريطة أو اختر من القائمة',
    revContrib:'مساهمة الإيرادات', growth:'النمو', totalRev:'إجمالي الإيرادات',
    orders:'الطلبات', contrib:'المساهمة', growthRate2:'معدل النمو',
    topChannels:'🏆 القنوات الرئيسية (أعلى 3)', popularProductsLabel:'📦 المنتجات الشائعة',
    channelRevByCountry:'إيرادات القنوات', regionRev:'📍 الإيرادات الإقليمية',
    genderRatio:'👥 نسبة الشراء حسب الجنس', male:'ذكر', female:'أنثى', other:'آخر',
    ageGroupRatio:'📊 نسبة الشراء حسب العمر',
    countryOverview:'نظرة عامة', countryChannel:'القنوات', countryRegion:'المنطقة', countryDemo:'التركيبة السكانية',
    unit:'',
  },
  hi: {
    liveGlobal:'लाइव · वैश्विक', countryStatus:'बिक्री', countries:' देश',
    totalGlobalRev:'कुल वैश्विक राजस्व', totalOrders:'कुल ऑर्डर', opProfit:'परिचालन लाभ',
    globalRevenue:'वैश्विक राजस्व', avgGrowth:'औसत वृद्धि', topMarket:'शीर्ष बाज़ार',
    activeCountries:'सक्रिय देश', channelPerf:'🏗 चैनल', growthRate:'📈 वृद्धि',
    popularProducts:'🏷 उत्पाद', channelRevRoas:'चैनल राजस्व और ROAS',
    shareRate:'हिस्सेदारी', highGrowthTop5:'🚀 शीर्ष 5 उच्च वृद्धि बाज़ार',
    cautionMarket:'⚠️ सावधानी बाज़ार (निम्न/नकारात्मक वृद्धि)',
    globalTopProducts:'शीर्ष 5 वैश्विक लोकप्रिय उत्पाद',
    mapClickHint:'💡 मानचित्र पर क्लिक करें या सूची से देश चुनें',
    countryRevRank:'🏆 देश के अनुसार राजस्व योगदान रैंकिंग',
    selectCountryHint:'विस्तृत विश्लेषण के लिए देश चुनें',
    selectFromMap:'मानचित्र मार्कर पर क्लिक करें या सूची से चुनें',
    revContrib:'राजस्व योगदान', growth:'वृद्धि', totalRev:'कुल राजस्व',
    orders:'ऑर्डर', contrib:'योगदान', growthRate2:'वृद्धि दर',
    topChannels:'🏆 प्रमुख चैनल (शीर्ष 3)', popularProductsLabel:'📦 लोकप्रिय उत्पाद',
    channelRevByCountry:'चैनल राजस्व', regionRev:'📍 क्षेत्रीय राजस्व',
    genderRatio:'👥 लिंग खरीद अनुपात', male:'पुरुष', female:'महिला', other:'अन्य',
    ageGroupRatio:'📊 आयु समूह खरीद अनुपात',
    countryOverview:'अवलोकन', countryChannel:'चैनल', countryRegion:'क्षेत्र', countryDemo:'जनसांख्यिकी',
    unit:'',
  },
};
