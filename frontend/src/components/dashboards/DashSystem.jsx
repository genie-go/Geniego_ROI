...
const LOC = {
  ...
  es: {
    systemStatus:'Estado del Sistema', avgLatency:'Latencia Prom.', totalRpm:'RPM Total',
    errorRate:'Tasa de Error', stable:'Estable', optimal:'Óptimo', throughput:'Rendimiento',
    target:'Objetivo', infraLatTrend:'Tendencia de Latencia de Infraestructura (14d, ms)',
    majorApiStatus:'⚙ Estado API Principal', systemOverview:'📊 Resumen del Sistema',
    sysRelChanges:'🛡 Cambios del Sistema', apiMonitoring:'📡 Monitoreo API en Tiempo Real',
    infraStability:'Estabilidad AWS, WMS, OrderHub',
    deploy:'Despliegue', trend14:'Tendencia de Tiempo de Respuesta 14d (ms)', sysMem:'Memoria del Sistema',
    apiSync:'Estado de Integración API', errTrend:'Estado de Tasa de Error',
    sloOk:'✅ SLO Cumplido', sloWarn:'⚠️ Monitoreo Requerido',
    noModules:'Sin módulos registrados', connectModules:'Conecte módulos para estado en tiempo real',
    secShield:'🛡️ Escudo de Seguridad', secureActive:'Monitoreo de Seguridad Activo',
    threatsBlocked:'Amenazas Bloqueadas', xssBlock:'XSS Bloqueado', csrfProtect:'CSRF Protegido',
    rateLimit:'Límite de Tasa', bruteForce:'Protección Fuerza Bruta',
    securityLog:'Registro de Seguridad', noThreats:'Sin Amenazas',
    critical:'Crítico', warning:'Advertencia', info:'Info',
    clickModule:'Haga clic en un módulo para ver detalles',
    allSystemsOp:'Todos los sistemas operativos',
  },
  fr: {
    systemStatus:'État du Système', avgLatency:'Latence Moy.', totalRpm:'RPM Total',
    errorRate:"Taux d'Erreur", stable:'Stable', optimal:'Optimal', throughput:'Débit',
    target:'Cible', infraLatTrend:'Tendance Latence Infrastructure (14j, ms)',
    majorApiStatus:'⚙ État API Principal', systemOverview:'📊 Vue du Système',
    sysRelChanges:'🛡 Changements Système', apiMonitoring:'📡 Surveillance API Temps Réel',
    infraStability:'Stabilité AWS, WMS, OrderHub',
    deploy:'Déploiement', trend14:'Tendance Temps de Réponse 14j (ms)', sysMem:'Mémoire Système',
    apiSync:"État d'Intégration API", errTrend:"État du Taux d'Erreur",
    sloOk:'✅ SLO Atteint', sloWarn:'⚠️ Surveillance Requise',
    noModules:'Aucun module enregistré', connectModules:'Connectez des modules pour le statut en temps réel',
    secShield:'🛡️ Bouclier de Sécurité', secureActive:'Surveillance de Sécurité Active',
    threatsBlocked:'Menaces Bloquées', xssBlock:'XSS Bloqué', csrfProtect:'CSRF Protégé',
    rateLimit:'Limite de Taux', bruteForce:'Protection Force Brute',
    securityLog:'Journal de Sécurité', noThreats:'Aucune Menace',
    critical:'Critique', warning:'Avertissement', info:'Info',
    clickModule:'Cliquez sur un module pour les détails',
    allSystemsOp:'Tous les systèmes opérationnels',
  },
  pt: {
    systemStatus:'Status do Sistema', avgLatency:'Latência Méd.', totalRpm:'RPM Total',
    errorRate:'Taxa de Erro', stable:'Estável', optimal:'Ótimo', throughput:'Throughput',
    target:'Meta', infraLatTrend:'Tendência de Latência da Infraestrutura (14d, ms)',
    majorApiStatus:'⚙ Status API Principal', systemOverview:'📊 Visão Geral do Sistema',
    sysRelChanges:'🛡 Alterações do Sistema', apiMonitoring:'📡 Monitoramento API em Tempo Real',
    infraStability:'Estabilidade AWS, WMS, OrderHub',
    deploy:'Deploy', trend14:'Tendência de Tempo de Resposta 14d (ms)', sysMem:'Memória do Sistema',
    apiSync:'Status de Integração API', errTrend:'Status da Taxa de Erro',
    sloOk:'✅ SLO Atingido', sloWarn:'⚠️ Monitoramento Necessário',
    noModules:'Nenhum módulo registrado', connectModules:'Conecte módulos para status em tempo real',
    secShield:'🛡️ Escudo de Segurança', secureActive:'Monitoramento de Segurança Ativo',
    threatsBlocked:'Ameaças Bloqueadas', xssBlock:'XSS Bloqueado', csrfProtect:'CSRF Protegido',
    rateLimit:'Limite de Taxa', bruteForce:'Proteção Força Bruta',
    securityLog:'Log de Segurança', noThreats:'Sem Ameaças',
    critical:'Crítico', warning:'Aviso', info:'Info',
    clickModule:'Clique em um módulo para ver detalhes',
    allSystemsOp:'Todos os sistemas operacionais',
  },
  ru: {
    systemStatus:'Статус системы', avgLatency:'Ср. задержка', totalRpm:'Всего RPM',
    errorRate:'Частота ошибок', stable:'Стабильно', optimal:'Оптимально', throughput:'Пропускная способность',
    target:'Цель', infraLatTrend:'Тренд задержки инфраструктуры (14д, мс)',
    majorApiStatus:'⚙ Статус основных API', systemOverview:'📊 Обзор системы',
    sysRelChanges:'🛡 Изменения системы', apiMonitoring:'📡 Мониторинг API в реальном времени',
    infraStability:'Стабильность AWS, WMS, OrderHub',
    deploy:'Развёртывание', trend14:'Тренд времени отклика 14д (мс)', sysMem:'Системная память',
    apiSync:'Статус интеграции API', errTrend:'Статус частоты ошибок',
    sloOk:'✅ SLO выполнен', sloWarn:'⚠️ Требуется мониторинг',
    noModules:'Нет зарегистрированных модулей', connectModules:'Подключите модули для статуса в реальном времени',
    secShield:'🛡️ Защитный щит', secureActive:'Мониторинг безопасности активен',
    threatsBlocked:'Заблокированные угрозы', xssBlock:'XSS заблокирован', csrfProtect:'CSRF защищён',
    rateLimit:'Ограничение запросов', bruteForce:'Защита от перебора',
    securityLog:'Журнал безопасности', noThreats:'Угроз нет',
    critical:'Критический', warning:'Предупреждение', info:'Инфо',
    clickModule:'Нажмите на модуль для подробностей',
    allSystemsOp:'Все системы работают',
  },
  ar: {
    systemStatus:'حالة النظام', avgLatency:'متوسط التأخير', totalRpm:'إجمالي RPM',
    errorRate:'معدل الأخطاء', stable:'مستقر', optimal:'مثالي', throughput:'الإنتاجية',
    target:'الهدف', infraLatTrend:'اتجاه تأخير البنية التحتية (14 يوم، مللي ثانية)',
    majorApiStatus:'⚙ حالة API الرئيسي', systemOverview:'📊 نظرة عامة على النظام',
    sysRelChanges:'🛡 تغييرات النظام', apiMonitoring:'📡 مراقبة API في الوقت الفعلي',
    infraStability:'استقرار AWS، WMS، OrderHub',
    deploy:'نشر', trend14:'اتجاه وقت الاستجابة 14 يوم (مللي ثانية)', sysMem:'ذاكرة النظام',
    apiSync:'حالة تكامل API', errTrend:'حالة معدل الأخطاء',
    sloOk:'✅ SLO محقق', sloWarn:'⚠️ مراقبة مطلوبة',
    noModules:'لا توجد وحدات مسجلة', connectModules:'قم بتوصيل الوحدات لرؤية الحالة الفعلية',
    secShield:'🛡️ درع الأمان', secureActive:'مراقبة الأمان نشطة',
    threatsBlocked:'تهديدات محظورة', xssBlock:'حظر XSS', csrfProtect:'حماية CSRF',
    rateLimit:'حد المعدل', bruteForce:'حماية القوة الغاشمة',
    securityLog:'سجل الأمان', noThreats:'لا تهديدات',
    critical:'حرج', warning:'تحذير', info:'معلومات',
    clickModule:'انقر على بطاقة وحدة لرؤية التفاصيل',
    allSystemsOp:'جميع الأنظمة تعمل',
  },
  hi: {
    systemStatus:'सिस्टम स्थिति', avgLatency:'औसत विलंब', totalRpm:'कुल RPM',
    errorRate:'त्रुटि दर', stable:'स्थिर', optimal:'इष्टतम', throughput:'थ्रूपुट',
    target:'लक्ष्य', infraLatTrend:'इंफ्रास्ट्रक्चर विलंब रुझान (14 दिन, ms)',
    majorApiStatus:'⚙ मुख्य API स्थिति', systemOverview:'📊 सिस्टम अवलोकन',
    sysRelChanges:'🛡 सिस्टम परिवर्तन', apiMonitoring:'📡 रीयल-टाइम API निगरानी',
    infraStability:'AWS, WMS, OrderHub स्थिरता',
    deploy:'डिप्लॉय', trend14:'14 दिन प्रतिक्रिया समय रुझान (ms)', sysMem:'सिस्टम मेमोरी',
    apiSync:'API एकीकरण स्थिति', errTrend:'त्रुटि दर स्थिति',
    sloOk:'✅ SLO पूरा', sloWarn:'⚠️ निगरानी आवश्यक',
    noModules:'कोई मॉड्यूल पंजीकृत नहीं', connectModules:'रीयल-टाइम स्थिति के लिए मॉड्यूल कनेक्ट करें',
    secShield:'🛡️ सुरक्षा कवच', secureActive:'सुरक्षा निगरानी सक्रिय',
    threatsBlocked:'अवरुद्ध खतरे', xssBlock:'XSS अवरुद्ध', csrfProtect:'CSRF सुरक्षित',
    rateLimit:'दर सीमा', bruteForce:'ब्रूट फ़ोर्स सुरक्षा',
    securityLog:'सुरक्षा लॉग', noThreats:'कोई खतरा नहीं',
    critical:'गंभीर', warning:'चेतावनी', info:'सूचना',
    clickModule:'विवरण के लिए मॉड्यूल कार्ड पर क्लिक करें',
    allSystemsOp:'सभी सिस्टम चालू',
  },
};
