...
const ORBIT_TXT = {
    marketing: {
        ko: ["마케팅", "멀티채널 캠페인·광고 ROAS 최적화"], en: ["Marketing", "Multi-channel campaign & ad ROAS optimization"],
        ja: ["マーケティング", "マルチチャネルのキャンペーン・広告ROAS最適化"], zh: ["营销", "多渠道营销活动与广告 ROAS 优化"],
        "zh-TW": ["行銷", "多通路行銷活動與廣告 ROAS 最佳化"], de: ["Marketing", "Multichannel-Kampagnen- & Anzeigen-ROAS"],
        th: ["การตลาด", "ปรับ ROAS แคมเปญและโฆษณาหลายช่องทาง"], vi: ["Tiếp thị", "Tối ưu ROAS chiến dịch & quảng cáo đa kênh"],
        id: ["Pemasaran", "Optimasi ROAS kampanye & iklan multi-kanal"], ar: ["التسويق", "تحسين عائد الإنفاق الإعلاني متعدد القنوات"],
        es: ["Marketing", "Optimización de ROAS de campañas multicanal"], fr: ["Marketing", "Optimisation du ROAS des campagnes multicanal"],
        hi: ["मार्केटिंग", "मल्टी-चैनल कैम्पेन और विज्ञापन ROAS अनुकूलन"], pt: ["Marketing", "Otimização de ROAS de campanhas multicanal"],
        ru: ["Маркетинг", "Оптимизация ROAS кампаний по каналам"],
    },
    commerce: {
    ...
    data: {
        ko: ["데이터 분석", "실시간 성과 인사이트"], en: ["Data Analytics", "Real-time performance insights"],
        ja: ["データ分析", "リアルタイム成果インサイト"], zh: ["数据分析", "实时绩效洞察"],
        "zh-TW": ["數據分析", "即時成效洞察"], de: ["Datenanalyse", "Echtzeit-Performance-Insights"],
        th: ["วิเคราะห์ข้อมูล", "อินไซต์ประสิทธิภาพเรียลไทม์"], vi: ["Phân tích dữ liệu", "Thông tin hiệu suất thời gian thực"],
        id: ["Analitik Data", "Wawasan performa real-time"], ar: ["تحليل البيانات", "رؤى أداء لحظية"],
        es: ["Analítica de datos", "Insights de rendimiento en tiempo real"], fr: ["Analyse de données", "Insights de performance en temps réel"],
        hi: ["डेटा विश्लेषण", "रियल-टाइम प्रदर्शन इनसाइट्स"], pt: ["Análise de dados", "Insights de desempenho em tempo real"],
        ru: ["Анализ данных", "Аналитика эффективности в реальном времени"],
    },
    settle: {
    ...
    ai: {
        ko: ["마케팅 자동화", "규칙 기반 워크플로우·분석 추천"], en: ["Marketing Automation", "Rule-based workflows & analytics-assisted recommendations"],
        ja: ["マーケティング自動化", "ルールベースのワークフローと分析推奨"], zh: ["营销自动化", "规则化工作流与分析辅助建议"],
        "zh-TW": ["行銷自動化", "規則化工作流與分析輔助建議"], de: ["Marketing-Automatisierung", "Regelbasierte Workflows & analytikgestützte Empfehlungen"],
        th: ["ระบบอัตโนมัติการตลาด", "เวิร์กโฟลว์ตามกฎและคำแนะนำจากการวิเคราะห์"], vi: ["Tự động hóa marketing", "Workflow theo quy tắc & khuyến nghị từ phân tích"],
        id: ["Otomasi Marketing", "Workflow berbasis aturan & rekomendasi analitik"], ar: ["أتمتة التسويق", "مسارات عمل قائمة على القواعد وتوصيات تحليلية"],
        es: ["Automatización de marketing", "Flujos por reglas y recomendaciones analíticas"], fr: ["Automatisation marketing", "Workflows à règles & recommandations analytiques"],
        hi: ["मार्केटिंग स्वचालन", "नियम-आधारित वर्कफ़्लो और एनालिटिक्स सिफ़ारिशें"], pt: ["Automação de marketing", "Workflows por regras & recomendações analíticas"],
        ru: ["Автоматизация маркетинга", "Процессы по правилам и рекомендации на базе аналитики"],
    },
};
const ORBIT_ANALYZING = {
    ko: "실시간 성과 분석", en: "Live performance analysis", ja: "リアルタイム成果分析", zh: "实时绩效分析", "zh-TW": "即時成效分析",
    de: "Echtzeit-Performance-Analyse", th: "วิเคราะห์ประสิทธิภาพเรียลไทม์", vi: "Phân tích hiệu suất thời gian thực", id: "Analisis performa real-time",
    ar: "تحليل الأداء اللحظي", es: "Análisis de rendimiento en vivo", fr: "Analyse de performance en direct", hi: "रियल-टाइम प्रदर्शन विश्लेषण",
    pt: "Análise de desempenho ao vivo", ru: "Анализ эффективности в реальном времени",
};
