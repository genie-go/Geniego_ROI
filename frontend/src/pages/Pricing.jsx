...
function getCompareRows(t) {
  return [
  { label: t("cmpRow.r1"),  growth: "✓ "+t("cmpVal.realtime"), pro: "✓ "+t("cmpVal.all"), enterprise: "✓ "+t("cmpVal.all") },
  { label: t("cmpRow.r2"),  growth: "✓ "+t("cmpVal.domestic_core"), pro: "✓ All + A/B", enterprise: "✓ "+t("cmpVal.all") },
  { label: t("cmpRow.r3"),  growth: "—", pro: "✓", enterprise: "✓" },
  { label: t("cmpRow.r4"),  growth: "—", pro: "✓", enterprise: "✓" },
  { label: t("cmpRow.r5"),  growth: "—", pro: "✓ "+t("cmpVal.basic_auto"), enterprise: "✓ "+t("cmpVal.advanced_custom") },
  { label: t("cmpRow.r6"),  growth: "✓ "+t("cmpVal.domestic"), pro: "✓ "+t("cmpVal.dom_global"), enterprise: "✓ + "+t("cmpVal.market_share") },
  { label: t("cmpRow.r7"),  growth: "—", pro: "✓ Basic", enterprise: "✓ "+t("cmpVal.conv_path_all") },
  { label: t("cmpRow.r8"),  growth: "—", pro: "✓ Basic", enterprise: "✓ + "+t("cmpVal.trend_forecast") },
  { label: t("cmpRow.r9"),  growth: "✓ "+t("cmpVal.domestic"), pro: "✓ +WhatsApp/DM/LINE", enterprise: "✓ All + "+t("cmpVal.bizboard") },
  { label: t("cmpRow.r10"), growth: "—", pro: "✓ AI+UGC", enterprise: "✓ + "+t("cmpVal.competitor_compare") },
  { label: t("cmpRow.r11"), growth: "Coupang·Naver·Cafe24", pro: "✓ +Shopify·Amazon", enterprise: "✓ +Rakuten·Temu" },
  { label: t("cmpRow.r12"), growth: "✓ Basic", pro: "✓ + "+t("cmpVal.location_barcode"), enterprise: "✓ "+t("cmpVal.all") },
  { label: t("cmpRow.r13"), growth: t("cmpVal.list_view"), pro: "✓ Add·Edit", enterprise: "✓ + Delete·"+t("cmpVal.contract") },
  { label: t("cmpRow.r14"), growth: "—", pro: "—", enterprise: "✓ "+t("cmpVal.policy_review") },
  { label: t("cmpRow.r15"), growth: "✓ Basic", pro: "✓ "+t("cmpVal.cohort_pl"), enterprise: "✓ "+t("cmpVal.all") },
  { label: t("cmpRow.r16"), growth: t("cmpVal.notification_basic"), pro: "✓ "+t("cmpVal.rule_writeback"), enterprise: "✓ + "+t("cmpVal.instant_rollback") },
  { label: t("cmpRow.r17"), growth: "—", pro: "✓ Basic", enterprise: "✓ "+t("cmpVal.partner_api") },
  { label: t("cmpRow.r18"), growth: "—", pro: "✓ "+t("cmpVal.install_analysis"), enterprise: "✓ + "+t("cmpVal.server_side") },
  { label: t("cmpRow.r19"), growth: t("cmpVal.domestic_ads"), pro: "✓ All + API·Pixel", enterprise: "✓ + Data Product" },
  { label: t("cmpRow.r20"), growth: "—", pro: t("cmpVal.schema_quality_view"), enterprise: "✓ SLA·"+t("cmpVal.owner_streaming") },
  { label: t("cmpRow.r21"), growth: "✓ "+t("cmpVal.custom_excel"), pro: "✓ + "+t("cmpVal.anomaly_detect"), enterprise: "✓ + "+t("cmpVal.auto_scheduled_share") },
  { label: t("cmpRow.r22"), growth: "✓ "+t("cmpVal.manual"), pro: "✓ "+t("cmpVal.realtime_rate"), enterprise: "✓ "+t("cmpVal.realtime_rate") },
  { label: t("cmpRow.r23"), growth: "—", pro: t("cmpVal.perf_view"), enterprise: "✓ DB·"+t("cmpVal.campaign_settle") },
  { label: t("cmpRow.r24"), growth: "—", pro: "✓ Run·"+t("cmpVal.reprocess"), enterprise: "✓ + "+t("cmpVal.notification_send") },
  { label: t("cmpRow.r25"), growth: t("cmpVal.own_history"), pro: t("cmpVal.own_history"), enterprise: "✓ All·Export" },
  { label: t("cmpRow.r26"), growth: t("cmpVal.list_invite"), pro: "✓ + "+t("cmpVal.activity_history"), enterprise: "✓ "+t("cmpVal.rbac_role") },
  { label: t("cmpRow.r27"), growth: "1~"+t("cmpVal.unlimited"), pro: "1~"+t("cmpVal.unlimited"), enterprise: t("cmpVal.unlimited") },
  { label: t("cmpRow.r28"), growth: t("cmpVal.chat_support"), pro: t("cmpVal.dedicated_manager"), enterprise: t("cmpVal.dedicated_sla") },
  ];
}


const PLAN_COLOR = {
  starter: "#22c55e", growth: "#4f8ef7", pro: "#a855f7", enterprise: "#f59e0b"
};

const USD = (v) => (v > 0 ? "$" + Number(v).toLocaleString("en-US") : null);
...
function PlanCard({ plan, cycle, selectedAcct, onAcctChange, onSubscribe, paying, currentPlanId, cycleDiscountMap }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 11, color: "var(--text-3)", marginBottom: 14, lineHeight: 1.5, minHeight: 32 }}>
      ...
      {plan.tiers && plan.tiers.length > 0 && (
        <div style={{ marginBottom: 14 }}>
          <label style={{ fontSize: 9, color: "var(--text-3)", fontWeight: 700, display: "block", marginBottom: 5, textTransform: "uppercase", letterSpacing: 1 }}>
            {t("pricing.acctSelect")}
          </label>
        ...
        {plan.hasPricing && price ? (
          <div>
            <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
              <span style={{ fontSize: 30, fontWeight: 900, color: planColor }}>{USD(price)}</span>
              <span style={{ fontSize: 11, color: "var(--text-3)" }}>/{t("pricing.cycleMonthly")}</span>
            </div>
            {!isMonthly && total && (
              <div style={{ marginTop: 4, fontSize: 11, color: 'var(--text-3)' }}>
                {months}{t("pricing.totalLabel")}{" "}
                <strong style={{ color: "#22c55e" }}>{USD(total)}</strong>
                {(cycleDiscountMap?.[cycle]) && (
                  <span style={{ marginLeft: 6, fontSize: 9, padding: "1px 6px", borderRadius: 8, background: "rgba(34,197,94,0.12)", color: "#22c55e", fontWeight: 800 }}>
                    -{cycleDiscountMap[cycle]}
                  </span>
                )}
              </div>
          ...
          <div style={{ fontSize: 13, color: 'var(--text-3)', fontStyle: "italic", paddingTop: 8 }}>{t("pricing.registerSoon")}</div>
        )}
      </div>
      ...
      <div style={{ flex: 1, display: "grid", gap: 6, marginBottom: 12 }}>
        {(detail.sections || []).slice(0, 3).map((sec, si) => (
          <div key={si} style={{ display: "flex", alignItems: "flex-start", gap: 7, fontSize: 11, color: 'var(--text-2)' }}>
        ...
        {(detail.limits || []).slice(0, 2).map((l, li) => (
          <div key={"l" + li} style={{ display: "flex", alignItems: "flex-start", gap: 7, fontSize: 11, color: 'var(--text-3)' }}>
            ...
            <div key={si} style={{
              ...
              <div style={{ display: "grid", gap: 4 }}>
                {sec.items.map((item, ii) => (
                  <div key={ii} style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 10, color: 'var(--text-2)' }}>
          ...
          {(detail.limits || []).length > 0 && (
            <div style={{ padding: "8px 12px", borderRadius: 10, background: "rgba(239,68,68,0.05)", border: "1px solid rgba(239,68,68,0.15)" }}>
              ...
              {detail.limits.map((l, li) => (
                <div key={li} style={{ fontSize: 10, color: "var(--text-3)", display: "flex", gap: 5, marginBottom: 2 }}>
...
function CompareTable({ plans }) {
  const t = useT();
  const PLAN_DETAIL = getPlanDetail(t);
  const planIds = ["growth", "pro", "enterprise"];
  ...
  return (
    <div style={{ overflowX: "auto", marginTop: 4 }}>
      <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 560 }}>
        <thead>
          <tr>
            <th style={{ padding: "10px 14px", textAlign: "left", fontSize: 11, color: "var(--text-3)", fontWeight: 700, borderBottom: "1px solid rgba(255,255,255,0.07)", minWidth: 160 }}>{t("pricing.compareFeature")}</th>
            {visiblePlans.map(id => {
              const p = plans.find(pl => pl.id === id);
              const d = PLAN_DETAIL[id] || {};
              return (
                <th key={id} style={{ padding: "10px 8px", textAlign: "center", fontSize: 11, fontWeight: 800, color: d.color || "#fff", borderBottom: "1px solid rgba(255,255,255,0.07)", minWidth: 110 }}>
        ...
        <tbody>
          {getCompareRows(t).map((row, i) => (
            <tr key={i} style={{ background: i % 2 === 0 ? "var(--surface)" : "transparent" }}>
              <td style={{ padding: "8px 14px", fontSize: 11, color: 'var(--text-2)', borderBottom: "1px solid rgba(255,255,255,0.04)" }}>{row.label}</td>
              {visiblePlans.map(id => {
                const val = row[id] || "—";
...
export default function Pricing() {
  ...
  const { locked } = useSecurityMonitor('pricing');
    ...
    fetch("/api/auth/pricing/public-plans")
      ...
      .then(d => {
        if (d.ok) {
          ...
          // Starter·Free 플랜 제외 — Growth / Pro / Enterprise 3단계만 표시
          const HIDDEN_PLANS = ["starter", "free"];
...
import { useI18n } from '../i18n/index.js';\nAccount: ${tierData?.label || ""}\nAmount: ${USD(cycleData.total_price)}\nCycle: ${t("pricing." + CYCLE_LABEL_KEY[cycle])}\n\nPayment will proceed when VITE_TOSS_CLIENT_KEY is configured.`);
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#060610 0%,#0a0f2a 50%,#060610 100%)", padding: "48px 24px 80px", fontFamily: "'Inter', 'Segoe UI', sans-serif", color: "#e8eaf6" }}>
      <style>{`
      ...
      <div style={{ textAlign: "center", maxWidth: 760, margin: "0 auto 48px", animation: "fadeUp 0.5s ease" }}>
        <div style={{ display: "inline-block", padding: "4px 18px", borderRadius: 20, marginBottom: 18, background: "rgba(79,142,247,0.1)", border: "1px solid rgba(79,142,247,0.3)", fontSize: 11, color: "#4f8ef7", fontWeight: 700, letterSpacing: 1.5, textTransform: "uppercase" }}>
          {t("pricing.badge").toUpperCase()}
        </div>
        <h1 style={{ fontSize: "clamp(26px,4vw,44px)", fontWeight: 900, margin: "0 0 14px", background: "linear-gradient(135deg,#fff 0%,#a5b4fc 100%)" }}>
          {t("pricing.heroTitle")}
        </h1>
        <p style={{ fontSize: 14, color: 'var(--text-3)', lineHeight: 1.8, margin: "0 0 20px" }}>
          {t("pricing.heroDesc")}<br />
          {(() => {
            // 관리자 설정 할인율에서 최대값 동적 계산 (하드코딩 제거)
            const allDiscVals = Object.values(cycleDiscountMap).map(v => parseFloat(v) || 0);
            const maxDisc = allDiscVals.length > 0 ? Math.max(...allDiscVals) : 0;
            return maxDisc > 0
              ? <>{t("pricing.heroSaving")} <strong style={{ color: "#22c55e" }}>최대 {maxDisc}% 절약</strong></>
        ...
        {CYCLE_ORDER.map(ck => {
          ...
          return (
            <button key={ck} className="cycle-btn" onClick={() => setCycle(ck)} style={{
              ...
              {discLabel && (
                <span style={{ position: "absolute", top: -9, right: -6, fontSize: 9, padding: "1px 6px", borderRadius: 9, background: "#22c55e", color: '#fff', fontWeight: 900, whiteSpace: "nowrap" }}>
                  -{discLabel}
                </span>
              )}
            </button>
      ...
      {/* 플랜 Card 그리드 */}
      {loading ? (
        <div style={{ textAlign: "center", color: "var(--text-3)", padding: "80px 0", fontSize: 14 }}>
          <div style={{ fontSize: 32, marginBottom: 12, animation: "glow 1.5s ease infinite" }}>⏳</div>
          {t("pricing.loadingText")}
        </div>
      ) : (
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16, maxWidth: 1360, margin: "0 auto" }}>
          {plans.map(plan => (
      ...
      {!loading && plans.length > 0 && (
        <div style={{ maxWidth: 960, margin: "52px auto 0" }}>
          <button
            ...
            style={{ display: "flex", alignItems: "center", gap: 8, margin: "0 auto 20px", padding: "10px 24px", borderRadius: 12, border: "1px solid rgba(79,142,247,0.3)", background: "rgba(79,142,247,0.06)", color: "#4f8ef7", fontSize: 13, fontWeight: 700, cursor: "pointer", transition: "all 200ms" }}
          >
            {showCompare ? t("pricing.compareBtnHide") : t("pricing.compareBtnShow")}
          </button>

          {showCompare && (
            <div style={{ background: "rgba(255,255,255,0.025)", border: '1px solid var(--border)', borderRadius: 16, overflow: "hidden", animation: "fadeUp 0.3s ease" }}>
      ...
      {/* Cost 절감 Banner */}
      <div style={{ maxWidth: 860, margin: "52px auto 0", background: "rgba(79,142,247,0.05)", border: "1px solid rgba(79,142,247,0.17)", borderRadius: 16, padding: "22px 28px", display: "flex", flexWrap: "wrap", gap: 20, alignItems: "center", justifyContent: "space-between" }}>
        <div>
          ...
          <div style={{ fontSize: 12, color: 'var(--text-3)', lineHeight: 2 }}>
            ...
            <strong style={{ color: "#ef4444" }}>$2,499+</strong>
            <br />
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 10, color: "var(--text-3)", fontWeight: 700, marginTop: 3 }}>{t("pricing.savingBold")}</div>
        </div>
      </div>
        ...
        {[
          ...
          <div key={i} style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            <button
              ...
              style={{ width: "100%", textAlign: "left", background: "none", border: "none", padding: "16px 0", cursor: "pointer", display: "flex", justifyContent: "space-between", alignItems: "center", color: "var(--text-3)", fontSize: 18, fontWeight: 700, transition: "transform 200ms", transform: faqOpen === i ? "rotate(45deg)" : "none" }}
            >
              {q}
              <span>+</span>
            </button>
            {faqOpen === i && (
              <div style={{ fontSize: 12, color: 'var(--text-3)', lineHeight: 1.8, paddingBottom: 16 }}>
                {a}
              </div>
            )}
          </div>
      ...
      <div style={{ maxWidth: 860, margin: "44px auto 0" }}>
        <button
          ...
          style={{ display: "flex", alignItems: "center", gap: 8, margin: "0 auto 20px", padding: "10px 24px", borderRadius: 12, border: "1px solid rgba(168,85,247,0.3)", background: "rgba(168,85,247,0.06)", color: "#a855f7", fontSize: 13, fontWeight: 700, cursor: "pointer" }}
        >
          {showGuide ? `📖 ${t("pricing.guideTitle")} ▲` : `📖 ${t("pricing.guideTitle")} ▼`}
        </button>
        {showGuide && (
          <div style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(168,85,247,0.15)", borderRadius: 16, padding: 24, animation: "fadeUp 0.3s ease" }}>
            <div style={{ textAlign: "center", marginBottom: 20 }}>
              ...
              <h2 style={{ fontSize: 20, fontWeight: 900, margin: "0 0 6px", color: '#fff' }}>{t("pricing.guideTitle")}</h2>
              <p style={{ color: 'var(--text-3)', fontSize: 12 }}>{t("pricing.guideSub")}</p>
            </div>
              ...
              {[1,2,3,4,5,6].map(i => (
                <div key={i} style={{ padding: 14, borderRadius: 12, background: "rgba(168,85,247,0.03)", border: "1px solid rgba(168,85,247,0.08)" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                    ...
                    <span style={{ fontWeight: 800, fontSize: 12, color: i<=2?'#a855f7':i<=4?'#4f8ef7':'#22c55e' }}>{t(`pricing.guideStep${i}Title`)}</span>
                  </div>
                  <p style={{ fontSize: 11, color: 'var(--text-3)', lineHeight: 1.5, margin: 0 }}>{t(`pricing.guideStep${i}Desc`)}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <p style={{ textAlign: "center", marginTop: 44, fontSize: 11, color: 'var(--text-3)' }}>
