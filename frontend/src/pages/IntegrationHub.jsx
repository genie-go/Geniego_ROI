...
export default function IntegrationHub() {
  ...
  const tabs = ["Connected","Marketplace","Logs","Settings"];
  const kpis = [{"emoji":"🔌","label":"Connected","val":14},{"emoji":"📡","label":"Available","val":45},{"emoji":"✅","label":"Healthy","val":13},{"emoji":"⚠️","label":"Attention","val":1}];
    ...
    <div style={{ padding: 24, minHeight: "100%", color: "var(--text-1, #1e293b)" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 22, fontWeight: 800, color: "var(--text-1, #1e293b)" }}>🔗 Integration Hub</div>
            <div style={{ fontSize: 13, color: "var(--text-3, #64748b)", marginTop: 2 }}>Connect and manage all third-party integrations</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 12 }}>
          {["One-click connect","Health monitoring","OAuth management","Webhook configuration"].map((f, i) => (
            <div key={i} style={{
