...
export default function Onboarding() {
  ...
  const tabs = ["Progress","Checklist","Resources","Support"];
  const kpis = [{"emoji":"✅","label":"Steps Done","val":"7/10"},{"emoji":"📊","label":"Progress","val":"70%"},{"emoji":"⏱️","label":"Est. Time","val":"15min"},{"emoji":"🎯","label":"Score","val":"A+"}];
    ...
    <div style={{ padding: 24, minHeight: "100%", color: "var(--text-1, #1e293b)" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 22, fontWeight: 800, color: "var(--text-1, #1e293b)" }}>🚀 Onboarding Wizard</div>
            <div style={{ fontSize: 13, color: "var(--text-3, #64748b)", marginTop: 2 }}>Step-by-step platform setup and configuration guide</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 12 }}>
          {["Interactive tutorials","Progress tracking","Context-sensitive help","Video guides"].map((f, i) => (
            <div key={i} style={{
