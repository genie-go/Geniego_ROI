...
export default function CaseStudy() {
  ...
  const tabs = ["All Cases","By Industry","By ROI","Bookmarked"];
  const kpis = [{"emoji":"📄","label":"Case Studies","val":24},{"emoji":"🏢","label":"Industries","val":8},{"emoji":"📈","label":"Avg ROI","val":"+340%"},{"emoji":"⭐","label":"Avg Rating","val":"4.8"}];
    ...
    <div style={{ padding: 24, minHeight: "100%", color: "var(--text-1, #1e293b)" }}>
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 22, fontWeight: 800, color: "var(--text-1, #1e293b)" }}>📚 Case Studies</div>
            <div style={{ fontSize: 13, color: "var(--text-3, #64748b)", marginTop: 2 }}>Real-world success stories and ROI benchmarks</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 12 }}>
          {["Detailed metrics","Before/After comparison","Implementation timeline","Customer testimonials"].map((f, i) => (
            <div key={i} style={{
