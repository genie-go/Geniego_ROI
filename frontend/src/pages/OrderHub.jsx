...
function GuideTab() {
    const { t } = useI18n();
    const g = (k) => { const v = t('orderHub.' + k, ''); return (v && !String(v).includes('orderHub.')) ? v : ''; };
        ...
        <div style={{ display: "grid", gap: 18 }}>
            ...
            {tips.length > 0 && (
                <div style={{ ...card, background: "rgba(34,197,94,0.04)", borderColor: "rgba(34,197,94,0.25)" }}>
                    <div style={secTitle}>💡 {t('orderHub.guideTipsTitle')}</div>
                    <div style={{ display: "grid", gap: 8 }}>
                        {tips.map((tip, i) => (
            ...
            {faqs.length > 0 && (
                <div style={card}>
                    <div style={secTitle}>❓ {g('guideFaqTitle') || t('orderHub.guideFaqTitle', '자주 묻는 질문')}</div>
