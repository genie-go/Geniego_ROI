...
export default function MyCoupons() {
  ...
  const tabs = ["Available","Used","Expired","Create New"];
  const kpis = [{"emoji":"🎟️","label":"Total Coupons","val":8},{"emoji":"✅","label":"Active","val":5},{"emoji":"⏰","label":"Expiring","val":2},{"emoji":"📊","label":"Used","val":14}];
    ...
    <div style={{ padding: 24, minHeight: "100%", color: "var(--text-1, #1e293b)" }}>
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 22, fontWeight: 800, color: "var(--text-1, #1e293b)" }}>🎟️ My Coupons</div>
            <div style={{ fontSize: 13, color: "var(--text-3, #64748b)", marginTop: 2 }}>Manage discount coupons and promotional offers</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 12 }}>
          {["Auto-apply at checkout","Stackable discounts","Usage tracking","Shareable links"].map((f, i) => (
            <div key={i} style={{
