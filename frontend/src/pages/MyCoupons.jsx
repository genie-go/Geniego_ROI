  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ color: "#fff", margin: "0 0 6px", fontSize: 20, fontWeight: 800 }}>🎟 Coupon Use하기</h2>
        ...
        <input
          ...
          style={{
            ...
            background: "rgba(255,255,255,0.05)", border: "1.5px solid rgba(79,142,247,0.25)",
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={onClose} style={{
            ...
            color: "rgba(255,255,255,0.6)", borderRadius: 10, padding: "12px", cursor: "pointer", fontSize: 14,
          }}>Cancel</button>
          <button onClick={handleRedeem} disabled={loading} style={{
            ...
            border: "none", color: "#fff", borderRadius: 10, padding: "12px", cursor: "pointer",
        ...
        {tabs.map(tab => (
          <button key={tab} onClick={() => setActiveTab(tab)} style={{
            ...
            {tab === "available" && availableCount > 0 && (
              <span style={{
                background: "#4f8ef7", color: "#fff", borderRadius: "999px",
