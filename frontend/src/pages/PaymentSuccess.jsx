        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", padding: "40px 20px" }}>
            {status === "confirming" && (
                <div style={{ textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: 16, fontWeight: 800, color: "var(--text-1)", marginBottom: 8 }}>Payment Confirm in progress...</div>
                ...
                <div style={{ textAlign: "center", maxWidth: 480, width: "100%" }}>
                    ...
                    <div style={{
                        ...
                        {[
                            ...
                            ["Payment Amount", amount > 0 ? KRW(amount) : "—"],
                ...
                <div style={{ textAlign: "center", maxWidth: 400 }}>
                    ...
                    <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
                        <button
                            ...
                            style={{
                                padding: "10px 24px", borderRadius: 10, border: "1px solid rgba(79,142,247,0.4)",
