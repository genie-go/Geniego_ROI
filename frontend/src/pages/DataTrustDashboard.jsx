...
export default function DataTrustDashboard() {
  ...
  const tabs = ["Score Overview","Lineage","Quality Rules","Compliance"];
  const kpis = [{"emoji":"🎯","label":"Trust Score","val":"94.7%"},{"emoji":"📊","label":"Data Sources","val":18},{"emoji":"✅","label":"Compliant","val":16},{"emoji":"⚠️","label":"Issues","val":2}];
    ...
    <div style={{ padding: 24, minHeight: "100%", color: "var(--text-1, #1e293b)" }}>
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 22, fontWeight: 800, color: "var(--text-1, #1e293b)" }}>🛡️ Data Trust Dashboard</div>
            <div style={{ fontSize: 13, color: "var(--text-3, #64748b)", marginTop: 2 }}>Data quality scoring, lineage tracking, and compliance monitoring</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 12 }}>
          {["Automated quality checks","Data lineage graph","GDPR compliance monitor","Anomaly alerts"].map((f, i) => (
            <div key={i} style={{
