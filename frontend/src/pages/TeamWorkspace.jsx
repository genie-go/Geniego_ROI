...
export default function TeamWorkspace() {
  ...
  const tabs = ["Activity Feed","Members","Tasks","Files"];
  const kpis = [{"emoji":"👤","label":"Members","val":12},{"emoji":"💬","label":"Comments","val":89},{"emoji":"📋","label":"Tasks","val":34},{"emoji":"✅","label":"Completed","val":28}];
    ...
    <div style={{ padding: 24, minHeight: "100%", color: "var(--text-1, #1e293b)" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 22, fontWeight: 800, color: "var(--text-1, #1e293b)" }}>👥 Team Workspace</div>
            <div style={{ fontSize: 13, color: "var(--text-3, #64748b)", marginTop: 2 }}>Collaborate with your team in real-time</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 12 }}>
          {["Real-time collaboration","Task assignment","File sharing","Activity timeline"].map((f, i) => (
            <div key={i} style={{
