    ...
    <div style={{ display: 'flex', flexDirection: 'column', margin: '-14px -16px -20px', height: 'calc(100vh - 52px)', overflow: 'hidden' }}>
      ...
      <div className="hero fade-up">
        <div className="hero-meta">
          ...
          <div>
            <div className="hero-title" style={{ background: "linear-gradient(135deg,#14d9b0,#a855f7)" }}>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  <div>
                    <div style={{ fontWeight: 700, fontSize: 13, color: p.color }}>{t("Data." + p.label) !== "Data." + p.label ? t("Data." + p.label) : p.label}</div>
              ...
              <div style={{ fontSize: 12, color: "var(--text-2)", lineHeight: 1.6, marginBottom: 10 }}>{t("Data." + p.desc) !== "Data." + p.desc ? t("Data." + p.desc) : p.desc}</div>
