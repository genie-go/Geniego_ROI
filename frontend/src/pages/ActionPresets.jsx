            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  <div>
                    <div style={{ fontWeight: 700, fontSize: 13, color: p.color }}>{t("demoData." + p.label) !== "demoData." + p.label ? t("demoData." + p.label) : p.label}</div>
              ...
              <div style={{ fontSize: 12, color: "var(--text-2)", lineHeight: 1.6, marginBottom: 10 }}>{t("demoData." + p.desc) !== "demoData." + p.desc ? t("demoData." + p.desc) : p.desc}</div>
