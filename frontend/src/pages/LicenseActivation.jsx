    ...
    return (
        <div style={{ marginTop: 10 }}>
            <button onClick={() => setOpen(v => !v)} style={{
                fontSize: 11, color: "#4f8ef7", background: "none", border: "none",
        ...
        <div className="card card-glass" style={{
                        ...
                        <div style={{ display: "flex", gap: 6 }}>
                            <input
                                ...
                                style={{
                                    ...
                                    background: "rgba(9,15,30,0.8)", border: "1px solid rgba(99,140,255,0.2)",
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 12, alignItems: "center", flexWrap: "wrap" }}>
                <button onClick={() => setShow(v => !v)} style={{
                    ...
                    border: "1px solid rgba(99,140,255,0.15)", borderRadius: 6, cursor: "pointer", padding: "5px 10px",
                }}>👁 {show ? "숨기기" : "보기"}</button>
            ...
            <div style={{ display: "flex", gap: 0, background: "rgba(9,15,30,0.6)", borderRadius: 12, border: "1px solid rgba(99,140,255,0.15)", overflow: "hidden" }}>
                {[
                    ...
                    <button key={s.n} onClick={() => setStep(s.n)} style={{
                        flex: 1, padding: "14px 20px", textAlign: "left", border: "none", cursor: "pointer",
                        background: step === s.n ? "rgba(79,142,247,0.12)" : "transparent",
                        borderRight: s.n < 2 ? "1px solid rgba(99,140,255,0.12)" : "none",
                    ...
                    {isPlanActive ? (
                        ...
                        <>
                            ...
                            <div>
                                ...
                                <div style={{ display: "flex", gap: 8 }}>
                                    ...
                                    <button onClick={() => setShowKey(v => !v)} style={{
                                        padding: "10px 14px", borderRadius: 10, border: "1px solid rgba(99,140,255,0.2)",
                                        background: "transparent", color: "var(--text-3)", cursor: "pointer", fontSize: 18,
                                    }}>👁</button>
                                </div>
                                {licError && (
                            ...
                            <button onClick={activateLicense} disabled={licBusy || !licenseKey.trim()} style={{
                                ...
                                opacity: licBusy || !licenseKey.trim() ? 0.6 : 1, transition: "all 0.2s",
                            }}>
            ...
            {step === 2 && (
                <div style={{ display: "grid", gap: 16 }}>
                    ...
                    <div className="card card-glass" style={{
                        ...
                        <button onClick={() => navigate("/api-keys")} style={{
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(200px,1fr))", gap: 10 }}>
                            {[
                                ...
                                <div key={c.name} style={{
                                    ...
                                    borderRadius: 9, background: "rgba(99,140,255,0.04)",
                    ...
                    <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
                        <button onClick={() => navigate("/connectors")} style={{
                            padding: "10px 20px", borderRadius: 10, border: "1px solid rgba(99,140,255,0.2)",
