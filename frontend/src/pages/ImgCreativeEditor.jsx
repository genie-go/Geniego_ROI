...
function ImgCreativeEditor({ chId, cr, color, onUpdate }) {
    ...
    const inpStyle = { width: '100%', background: 'rgba(0,0,0,0.35)', border: `1px solid ${color}33`, borderRadius: 7, color: '#e2e8f0', padding: '6px 10px', fontSize: 11, boxSizing: 'border-box' };
    return (
            ...
            {fields.map(([lbl, key, val, type, ph]) => (
                <div key={key}>
                    ...
                    {editing ? (
                        ...
                        <div style={{ padding: '6px 10px', borderRadius: 7, background: 'rgba(0,0,0,0.2)', border: `1px solid ${color}18`, fontSize: 11, color: 'var(--text-1)', minHeight: 30, lineHeight: 1.5 }}>
        ...
        <div style={{
            ...
            <div style={{ padding: '14px 16px', display: 'grid', gap: 12 }}>
                                ...
                                {[
                                    ...
                                    <div key={lbl}>
                                        ...
                                        <input value={val} onChange={e => set(e.target.value)} placeholder={ph}
                                            style={{ width: '100%', background: 'rgba(0,0,0,0.32)', border: `1px solid ${color}33`, borderRadius: 7, color: '#e2e8f0', padding: '5px 8px', fontSize: 11, boxSizing: 'border-box' }} />
                                    </div>
                                ))}
                                <div>
                                    ...
                                    <textarea value={bodyText} onChange={e => setBodyText(e.target.value)} rows={3}
                                        style={{ width: '100%', background: 'rgba(0,0,0,0.32)', border: `1px solid ${color}33`, borderRadius: 7, color: '#e2e8f0', padding: '5px 8px', fontSize: 11, boxSizing: 'border-box', resize: 'none' }} />
                                </div>
                            </div>
                        ) : (
                            <div style={{ display: 'grid', gap: 6 }}>
                                <div style={{ padding: '7px 10px', borderRadius: 8, background: 'rgba(0,0,0,0.2)', border: `1px solid ${color}22` }}>
                ...
                {creative && (creative.headline || creative.copy) && (
                    <div style={{ padding: '10px 12px', borderRadius: 9, background: 'rgba(0,0,0,0.2)', border: `1px solid ${color}22` }}>
