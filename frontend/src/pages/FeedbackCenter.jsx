...
export default function FeedbackCenter() {
  ...
  const tabs = ["Dashboard","Recent","Sentiment","Actions"];
  const kpis = [{"emoji":"📩","label":"Total Feedback","val":342},{"emoji":"😊","label":"Positive","val":"78%"},{"emoji":"😐","label":"Neutral","val":"15%"},{"emoji":"😞","label":"Negative","val":"7%"}];
    ...
    <div style={{ padding: 24, minHeight: "100%", color: "var(--text-1, #1e293b)" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 22, fontWeight: 800, color: "var(--text-1, #1e293b)" }}>💬 Feedback Center</div>
            <div style={{ fontSize: 13, color: "var(--text-3, #64748b)", marginTop: 2 }}>Customer feedback collection and sentiment analysis</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 12 }}>
          {["AI sentiment analysis","Auto-categorization","Response templates","Trend tracking"].map((f, i) => (
            <div key={i} style={{
