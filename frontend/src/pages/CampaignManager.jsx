                    ...
                    return (
                        <div key={c.id} className="card card-glass" style={{ borderLeft: `3px solid ${sm.color}`, cursor: "pointer" }}
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 12, flexWrap: "wrap", gap: 8 }}>
                                <div>
                                    <div style={{ fontWeight: 800, fontSize: 14 }}>{(t("demoData." + c.name) !== "demoData." + c.name ? t("demoData." + c.name) : c.name)}</div>
    ...
    return (
        <div style={{ display: "grid", gap: 16 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                    <div style={{ fontWeight: 900, fontSize: 18 }}>{(t("demoData." + c.name) !== "demoData." + c.name ? t("demoData." + c.name) : c.name)}</div>
                    ...
                    return (
                        <div key={c.id} style={{ display: "grid", gridTemplateColumns: "180px 1fr", gap: 0, marginBottom: 10, alignItems: "center" }}>
                            <div style={{ fontSize: 11, fontWeight: 700, paddingRight: 12, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                                {(t("demoData." + c.name) !== "demoData." + c.name ? t("demoData." + c.name) : c.name)}
                            </div>
                        ...
                        <tbody>{emailCampaigns.map(c => {
                            ...
                            return (
                                <tr key={c.id} style={{ borderTop: '1px solid rgba(99,140,255,0.07)' }}>
                                    <td style={{ padding: '7px 10px', fontWeight: 700 }}>{(t("demoData." + c.name) !== "demoData." + c.name ? t("demoData." + c.name) : c.name)}</td>
                                    ...
                                    <td style={{ padding: '7px 10px' }}><S s={(t("demoData." + c.status) !== "demoData." + c.status ? t("demoData." + c.status) : c.status)} /></td>
                                </tr>
                            );
                        })}</tbody>
                    </table>
