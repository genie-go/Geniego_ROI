...
const MOCK_KEYWORDS = [
  { keyword: "Wireless Earbuds",        channels: { coupang: { brand_sos: 18.4, comp_sos: 43.2, rank: 3, ctr: 4.2, rev_share: 22.1, vol: 82000 }, naver: { brand_sos: 21.1, comp_sos: 38.4, rank: 2, ctr: 5.1, rev_share: 25.3, vol: 68000 }, amazon: { brand_sos: 12.3, comp_sos: 51.2, rank: 5, ctr: 2.8, rev_share: 14.1, vol: 44000 } }, trend: "up" },
  { keyword: "Bluetooth Speaker",    channels: { coupang: { brand_sos: 11.7, comp_sos: 38.5, rank: 7, ctr: 3.1, rev_share: 13.4, vol: 65000 }, naver: { brand_sos: 9.8, comp_sos: 42.1, rank: 9, ctr: 2.7, rev_share: 10.2, vol: 54000 } }, trend: "down" },
  { keyword: "노이즈캔슬링 헤드폰", channels: { coupang: { brand_sos: 29.3, comp_sos: 27.1, rank: 1, ctr: 5.8, rev_share: 35.7, vol: 41000 }, naver: { brand_sos: 33.2, comp_sos: 22.4, rank: 1, ctr: 6.4, rev_share: 40.1, vol: 38000 }, amazon: { brand_sos: 25.8, comp_sos: 30.1, rank: 2, ctr: 4.9, rev_share: 31.2, vol: 29000 }, "11st": { brand_sos: 22.1, comp_sos: 35.2, rank: 3, ctr: 4.2, rev_share: 27.4, vol: 21000 } }, trend: "up" },
  { keyword: "스마트워치",          channels: { coupang: { brand_sos: 8.2, comp_sos: 55.4, rank: 12, ctr: 2.3, rev_share: 9.1, vol: 120000 }, naver: { brand_sos: 6.9, comp_sos: 58.1, rank: 14, ctr: 1.9, rev_share: 7.8, vol: 108000 } }, trend: "stable" },
  { keyword: "USB-C 허브",          channels: { coupang: { brand_sos: 22.6, comp_sos: 31.8, rank: 4, ctr: 4.9, rev_share: 27.3, vol: 34000 }, naver: { brand_sos: 19.4, comp_sos: 34.2, rank: 5, ctr: 4.2, rev_share: 23.1, vol: 28000 }, amazon: { brand_sos: 24.8, comp_sos: 28.9, rank: 3, ctr: 5.2, rev_share: 29.7, vol: 22000 } }, trend: "up" },
  { keyword: "게이밍 마우스",       channels: { coupang: { brand_sos: 15.9, comp_sos: 42.7, rank: 6, ctr: 3.7, rev_share: 18.8, vol: 58000 }, "11st": { brand_sos: 14.2, comp_sos: 44.8, rank: 7, ctr: 3.2, rev_share: 16.4, vol: 48000 } }, trend: "stable" },
  { keyword: "기계식 키보드",       channels: { coupang: { brand_sos: 34.1, comp_sos: 22.9, rank: 2, ctr: 6.1, rev_share: 41.2, vol: 47000 }, naver: { brand_sos: 36.8, comp_sos: 20.1, rank: 1, ctr: 6.8, rev_share: 44.9, vol: 41000 }, "11st": { brand_sos: 28.4, comp_sos: 26.7, rank: 2, ctr: 5.4, rev_share: 35.1, vol: 33000 } }, trend: "up" },
  { keyword: "포터블 충전기",       channels: { coupang: { brand_sos: 9.8, comp_sos: 49.3, rank: 9, ctr: 2.8, rev_share: 11.5, vol: 98000 }, naver: { brand_sos: 8.2, comp_sos: 52.1, rank: 11, ctr: 2.4, rev_share: 9.8, vol: 84000 } }, trend: "down" },
  { keyword: "4K 웹캠",             channels: { coupang: { brand_sos: 41.2, comp_sos: 18.4, rank: 1, ctr: 7.2, rev_share: 48.9, vol: 22000 }, amazon: { brand_sos: 38.7, comp_sos: 21.3, rank: 1, ctr: 6.9, rev_share: 45.2, vol: 18000 } }, trend: "up" },
  { keyword: "게이밍 헤드셋",       channels: { coupang: { brand_sos: 19.3, comp_sos: 36.8, rank: 5, ctr: 4.1, rev_share: 21.7, vol: 39000 }, "11st": { brand_sos: 17.8, comp_sos: 38.2, rank: 6, ctr: 3.8, rev_share: 19.4, vol: 31000 } }, trend: "stable" },
];
...
function AddKeywordModal({ onClose, onAdd }) {
  ...
  return (
    <>
      ...
      <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: "min(440px,94vw)", background: "linear-gradient(180deg,#0d1525,#090f1e)", border: "1px solid rgba(79,142,247,0.3)", borderRadius: 20, padding: 28, zIndex: 201, boxShadow: "0 24px 64px rgba(0,0,0,0.7)" }}>
    ...
    <div style={{ display: "grid", gap: 16 }}>
      ...
      <div className="hero fade-up">
        <div className="hero-grid">
          <div className="hero-meta">
            ...
            <div>
              <div className="hero-title" style={{ background: "linear-gradient(135deg,#14d9b0,#4f8ef7)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                Digital Shelf
              </div>
            ...
            <div key={i} style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 6 }}>
                ...
                <span style={{
                  ...
                  background: ins.level === "high" ? "rgba(34,197,94,0.15)" : ins.level === "warn" ? "rgba(234,179,8,0.15)" : "rgba(79,142,247,0.12)",
                  color: ins.level === "high" ? "#22c55e" : ins.level === "warn" ? "#eab308" : "#4f8ef7",
                }}>
                  {ins.action}
                </span>
              </div>
              ...
              return (
                <>
                  <tr key={kw.keyword}
                    ...
                    <td style={{ fontWeight: 600, color: "var(--text-1)" }}>{kw.keyword}</td>
      ...
      <div className="card card-glass fade-up fade-up-4">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 10 }}>
          {CHANNELS.map(ch => {
            const covered = MOCK_KEYWORDS.filter(kw => kw.channels[ch.id]).length;
            const top3 = MOCK_KEYWORDS.filter(kw => kw.channels[ch.id] && kw.channels[ch.id].rank <= 3).length;
            return (
              <div key={ch.id} style={{ padding: "14px 16px", borderRadius: 12, background: "rgba(9,15,30,0.6)", border: `1px solid ${ch.color}22` }}>
                ...
                <div style={{ marginTop: 8, height: 4, background: "rgba(255,255,255,0.06)", borderRadius: 4 }}>
                  <div style={{ width: `${(covered / MOCK_KEYWORDS.length) * 100}%`, height: "100%", background: ch.color, borderRadius: 4 }} />
                </div>
              </div>
            );
          })}
    ...
    <div style={{ display:'grid', gap:14, padding:4 }}>
      <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:10 }}>
        {[{l:'최적 리스팅',v:LISTINGS.filter(l=>totalScore(l)>=90).length+'개',c:'#22c55e'},{l:'개선 필요',v:LISTINGS.filter(l=>totalScore(l)<75).length+'개',c:'#ef4444'},{l:'Average 품질점Count',v:Math.round(LISTINGS.reduce((s,l)=>s+totalScore(l),0)/LISTINGS.length)+'점',c:'#4f8ef7'}].map(({l,v,c})=>(
          <div key={l} style={{background:'rgba(255,255,255,0.03)',borderRadius:12,padding:'12px',border:`1px solid ${c}22`}}>
      ...
      {LISTINGS.map(l => {
        ...
        return (
          <div key={l.sku} style={{background:'rgba(255,255,255,0.03)',border:`1px solid ${scoreColor(score)}22`,borderRadius:14,padding:16}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(5,1fr)',gap:8,marginBottom:12}}>
              {[['제목',l.title],['Image',l.images],['Description',l.desc],['스펙',l.spec],['키워드',l.keywords]].map(([lbl,val])=>(
                <div key={lbl} style={{textAlign:'center'}}>
                  ...
                  <div style={{height:40,background:'rgba(255,255,255,0.06)',borderRadius:4,position:'relative',overflow:'hidden'}}>
...
function ReviewAnalysisSection() {
  ...
  return (
    <div style={{display:'grid',gap:16,padding:4}}>
      {REVIEWS.map(r=>(
        <div key={r.sku} style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.07)',borderRadius:14,padding:16}}>
