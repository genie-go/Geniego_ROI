        ...
        <div style={{ display: "grid", gap: 18, maxWidth: 1000 }}>
            ...
            {isDemo && (
                <div style={{
                    ...
                    <div>
                        <div style={{ fontWeight: 700, fontSize: 13, color: "#eab308" }}>체험 Demo Mode — 가상 샘플 데이터로 열람 in progress</div>
            ...
            <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 16 }}>
                    <div style={{
                        ...
                        fontSize: 26, boxShadow: "0 8px 24px rgba(79,142,247,0.35)",
                    }}>📚</div>
                    <div>
                ...
                <div style={{ position: "relative", marginBottom: 14 }}>
                    ...
                    <input
                        ...
                        style={{
                            ...
                            borderRadius: 12, border: "1px solid rgba(79,142,247,0.3)",
                    ...
                    {searchResults.map((r, i) => (
                        <div
                            ...
                            style={{
                                ...
                                borderColor: r.type === "menu" ? "rgba(79,142,247,0.3)"
                    ...
                    <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                        {TABS.map(tb => (
                            <button key={tb.id} onClick={() => setTab(tb.id)} style={{
                                ...
                                background: tab === tb.id ? "linear-gradient(135deg,#4f8ef7,#a855f7)" : "var(--surface)",
                                color: tab === tb.id ? "#fff" : "var(--text-2)",
                                boxShadow: tab === tb.id ? "0 4px 14px rgba(79,142,247,0.3)" : "none",
                                            ...
                                            <div key={m.path} id={`menu-${m.path.replace(/\//g, "_")}`}
                                                ...
                                                <button
                                                    ...
                                                    style={{
                                                        ...
                                                        padding: "12px 14px", background: openMenu === m.path
                                                            ? "rgba(79,142,247,0.06)" : "rgba(255,255,255,0.02)",
                                                ...
                                                >
                                                    ...
                                                    <span style={{
                                                        ...
                                                        transform: openMenu === m.path ? "rotate(90deg)" : "none",
                                                        transition: "200ms",
                                                    }}>▶</span>
                                                </button>
                                    ...
                                    <div key={i} style={{ borderRadius: 10, border: "1px solid var(--border)", overflow: "hidden" }}>
                                        <button
                                            ...
                                            style={{
                                                ...
                                                background: faqOpen === i ? "rgba(79,142,247,0.06)" : "rgba(255,255,255,0.02)",
                                                border: "none", cursor: "pointer", textAlign: "left",
                                                display: "flex", alignItems: "center", gap: 10,
                                            }}
                                        >
                                            <span style={{ fontSize: 14, color: "#4f8ef7", fontWeight: 800, flexShrink: 0 }}>Q</span>
                                            <span style={{ flex: 1, fontSize: 13, fontWeight: 600, color: "var(--text-1)" }}>{faq.q}</span>
                                            <span style={{
                                                fontSize: 12, color: "var(--text-3)",
                                                transform: faqOpen === i ? "rotate(180deg)" : "none", transition: "200ms",
                                            }}>▼</span>
                                        </button>
                                        {faqOpen === i && (
                                            <div style={{
                            ...
                            {API_GUIDE.map(g => (
                                <div key={g.service} style={{ ...card, borderLeft: `3px solid ${g.color}` }}>
                                    ...
                                    <button
                                        ...
                                        style={{
                                            marginTop: 12, padding: "7px 14px", borderRadius: 7, border: "none",
                                            cursor: "pointer", background: g.color,
                                            color: "#fff", fontWeight: 700, fontSize: 11,
                                        }}
                                    >
                                        {t("help.apiGoTo")}
