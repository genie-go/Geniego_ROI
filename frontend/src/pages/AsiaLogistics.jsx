            ...
            {activeTab === 'hubs' && (
                <div className="fade-up">
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 14 }}>
                        {HUBS.map(hub => (
                            <div key={hub.id} style={{ background: 'var(--surface)', border:`1px solid ${STATUS_COLOR[hub.status]}30`, borderRadius:14, padding:16, cursor:'pointer', transition:'all 0.2s', boxShadow: activeHub===hub.id?`0 0 0 2px ${STATUS_COLOR[hub.status]}`:'none' }}
                                ...
                                {[
                                    ...
                                    <div key={key}>
                                        ...
                                        <input type={type} value={newCarrier[key]} placeholder={ph}
                                            ...
                                            style={{ width:'100%', padding:'7px 10px', borderRadius:8, border: '1px solid var(--border)', background: 'var(--surface)', color: '#fff', fontSize:12, boxSizing:'border-box' }} />
                                    </div>
                                ))}
                            </div>
