...
<div style={{fontSize:20,fontWeight:800,color:'#1e293b'}}>{tr('guideTitle')}</div>
...
`;
fs.writeFileSync('src/pages/ReturnsPortal.jsx',code);
console.log('ReturnsPortal.jsx written: '+code.length+' bytes');
